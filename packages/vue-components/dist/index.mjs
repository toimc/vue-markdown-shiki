...
var B = {};
const ys = "Á", vs = "á", xs = "Ă", As = "ă", Ss = "∾", Ls = "∿", Cs = "∾̳", Es = "Â", Ts = "â", Ds = "´", qs = "А", js = "а", Rs = "Æ", Ns = "æ", Ps = "⁡", Is = "𝔄", Os = "𝔞", Fs = "À", Ms = "à", Bs = "ℵ", $s = "ℵ", zs = "Α", Gs = "α", Us = "Ā", Hs = "ā", Vs = "⨿", Ws = "&", Zs = "&", Js = "⩕", Qs = "⩓", Ys = "∧", Xs = "⩜", Ks = "⩘", er = "⩚", nr = "∠", tr = "⦤", or = "∠", sr = "⦨", rr = "⦩", cr = "⦪", ar = "⦫", ir = "⦬", lr = "⦭", ur = "⦮", pr = "⦯", hr = "∡", dr = "∟", fr = "⊾", mr = "⦝", gr = "∢", _r = "Å", br = "⍼", kr = "Ą", wr = "ą", yr = "𝔸", vr = "𝕒", xr = "⩯", Ar = "≈", Sr = "⩰", Lr = "≊", Cr = "≋", Er = "'", Tr = "⁡", Dr = "≈", qr = "≊", jr = "Å", Rr = "å", Nr = "𝒜", Pr = "𝒶", Ir = "≔", Or = "*", Fr = "≈", Mr = "≍", Br = "Ã", $r = "ã", zr = "Ä", Gr = "ä", Ur = "∳", Hr = "⨑", Vr = "≌", Wr = "϶", Zr = "‵", Jr = "∽", Qr = "⋍", Yr = "∖", Xr = "⫧", Kr = "⊽", ec = "⌅", nc = "⌆", tc = "⌅", oc = "⎵", sc = "⎶", rc = "≌", cc = "Б", ac = "б", ic = "„", lc = "∵", uc = "∵", pc = "∵", hc = "⦰", dc = "϶", fc = "ℬ", mc = "ℬ", gc = "Β", _c = "β", bc = "ℶ", kc = "≬", wc = "𝔅", yc = "𝔟", vc = "⋂", xc = "◯", Ac = "⋃", Sc = "⨀", Lc = "⨁", Cc = "⨂", Ec = "⨆", Tc = "★", Dc = "▽", qc = "△", jc = "⨄", Rc = "⋁", Nc = "⋀", Pc = "⤍", Ic = "⧫", Oc = "▪", Fc = "▴", Mc = "▾", Bc = "◂", $c = "▸", zc = "␣", Gc = "▒", Uc = "░", Hc = "▓", Vc = "█", Wc = "=⃥", Zc = "≡⃥", Jc = "⫭", Qc = "⌐", Yc = "𝔹", Xc = "𝕓", Kc = "⊥", ea = "⊥", na = "⋈", ta = "⧉", oa = "┐", sa = "╕", ra = "╖", ca = "╗", aa = "┌", ia = "╒", la = "╓", ua = "╔", pa = "─", ha = "═", da = "┬", fa = "╤", ma = "╥", ga = "╦", _a = "┴", ba = "╧", ka = "╨", wa = "╩", ya = "⊟", va = "⊞", xa = "⊠", Aa = "┘", Sa = "╛", La = "╜", Ca = "╝", Ea = "└", Ta = "╘", Da = "╙", qa = "╚", ja = "│", Ra = "║", Na = "┼", Pa = "╪", Ia = "╫", Oa = "╬", Fa = "┤", Ma = "╡", Ba = "╢", $a = "╣", za = "├", Ga = "╞", Ua = "╟", Ha = "╠", Va = "‵", Wa = "˘", Za = "˘", Ja = "¦", Qa = "𝒷", Ya = "ℬ", Xa = "⁏", Ka = "∽", ei = "⋍", ni = "⧅", ti = "\\", oi = "⟈", si = "•", ri = "•", ci = "≎", ai = "⪮", ii = "≏", li = "≎", ui = "≏", pi = "Ć", hi = "ć", di = "⩄", fi = "⩉", mi = "⩋", gi = "∩", _i = "⋒", bi = "⩇", ki = "⩀", wi = "ⅅ", yi = "∩︀", vi = "⁁", xi = "ˇ", Ai = "ℭ", Si = "⩍", Li = "Č", Ci = "č", Ei = "Ç", Ti = "ç", Di = "Ĉ", qi = "ĉ", ji = "∰", Ri = "⩌", Ni = "⩐", Pi = "Ċ", Ii = "ċ", Oi = "¸", Fi = "¸", Mi = "⦲", Bi = "¢", $i = "·", zi = "·", Gi = "𝔠", Ui = "ℭ", Hi = "Ч", Vi = "ч", Wi = "✓", Zi = "✓", Ji = "Χ", Qi = "χ", Yi = "ˆ", Xi = "≗", Ki = "↺", el = "↻", nl = "⊛", tl = "⊚", ol = "⊝", sl = "⊙", rl = "®", cl = "Ⓢ", al = "⊖", il = "⊕", ll = "⊗", ul = "○", pl = "⧃", hl = "≗", dl = "⨐", fl = "⫯", ml = "⧂", gl = "∲", _l = "”", bl = "’", kl = "♣", wl = "♣", yl = ":", vl = "∷", xl = "⩴", Al = "≔", Sl = "≔", Ll = ",", Cl = "@", El = "∁", Tl = "∘", Dl = "∁", ql = "ℂ", jl = "≅", Rl = "⩭", Nl = "≡", Pl = "∮", Il = "∯", Ol = "∮", Fl = "𝕔", Ml = "ℂ", Bl = "∐", $l = "∐", zl = "©", Gl = "©", Ul = "℗", Hl = "∳", Vl = "↵", Wl = "✗", Zl = "⨯", Jl = "𝒞", Ql = "𝒸", Yl = "⫏", Xl = "⫑", Kl = "⫐", eu = "⫒", nu = "⋯", tu = "⤸", ou = "⤵", su = "⋞", ru = "⋟", cu = "↶", au = "⤽", iu = "⩈", lu = "⩆", uu = "≍", pu = "∪", hu = "⋓", du = "⩊", fu = "⊍", mu = "⩅", gu = "∪︀", _u = "↷", bu = "⤼", ku = "⋞", wu = "⋟", yu = "⋎", vu = "⋏", xu = "¤", Au = "↶", Su = "↷", Lu = "⋎", Cu = "⋏", Eu = "∲", Tu = "∱", Du = "⌭", qu = "†", ju = "‡", Ru = "ℸ", Nu = "↓", Pu = "↡", Iu = "⇓", Ou = "‐", Fu = "⫤", Mu = "⊣", Bu = "⤏", $u = "˝", zu = "Ď", Gu = "ď", Uu = "Д", Hu = "д", Vu = "‡", Wu = "⇊", Zu = "ⅅ", Ju = "ⅆ", Qu = "⤑", Yu = "⩷", Xu = "°", Ku = "∇", ep = "Δ", np = "δ", tp = "⦱", op = "⥿", sp = "𝔇", rp = "𝔡", cp = "⥥", ap = "⇃", ip = "⇂", lp = "´", up = "˙", pp = "˝", hp = "`", dp = "˜", fp = "⋄", mp = "⋄", gp = "⋄", _p = "♦", bp = "♦", kp = "¨", wp = "ⅆ", yp = "ϝ", vp = "⋲", xp = "÷", Ap = "÷", Sp = "⋇", Lp = "⋇", Cp = "Ђ", Ep = "ђ", Tp = "⌞", Dp = "⌍", qp = "$", jp = "𝔻", Rp = "𝕕", Np = "¨", Pp = "˙", Ip = "⃜", Op = "≐", Fp = "≑", Mp = "≐", Bp = "∸", $p = "∔", zp = "⊡", Gp = "⌆", Up = "∯", Hp = "¨", Vp = "⇓", Wp = "⇐", Zp = "⇔", Jp = "⫤", Qp = "⟸", Yp = "⟺", Xp = "⟹", Kp = "⇒", eh = "⊨", nh = "⇑", th = "⇕", oh = "∥", sh = "⤓", rh = "↓", ch = "↓", ah = "⇓", ih = "⇵", lh = "̑", uh = "⇊", ph = "⇃", hh = "⇂", dh = "⥐", fh = "⥞", mh = "⥖", gh = "↽", _h = "⥟", bh = "⥗", kh = "⇁", wh = "↧", yh = "⊤", vh = "⤐", xh = "⌟", Ah = "⌌", Sh = "𝒟", Lh = "𝒹", Ch = "Ѕ", Eh = "ѕ", Th = "⧶", Dh = "Đ", qh = "đ", jh = "⋱", Rh = "▿", Nh = "▾", Ph = "⇵", Ih = "⥯", Oh = "⦦", Fh = "Џ", Mh = "џ", Bh = "⟿", $h = "É", zh = "é", Gh = "⩮", Uh = "Ě", Hh = "ě", Vh = "Ê", Wh = "ê", Zh = "≖", Jh = "≕", Qh = "Э", Yh = "э", Xh = "⩷", Kh = "Ė", ed = "ė", nd = "≑", td = "ⅇ", od = "≒", sd = "𝔈", rd = "𝔢", cd = "⪚", ad = "È", id = "è", ld = "⪖", ud = "⪘", pd = "⪙", hd = "∈", dd = "⏧", fd = "ℓ", md = "⪕", gd = "⪗", _d = "Ē", bd = "ē", kd = "∅", wd = "∅", yd = "◻", vd = "∅", xd = "▫", Ad = " ", Sd = " ", Ld = " ", Cd = "Ŋ", Ed = "ŋ", Td = " ", Dd = "Ę", qd = "ę", jd = "𝔼", Rd = "𝕖", Nd = "⋕", Pd = "⧣", Id = "⩱", Od = "ε", Fd = "Ε", Md = "ε", Bd = "ϵ", $d = "≖", zd = "≕", Gd = "≂", Ud = "⪖", Hd = "⪕", Vd = "⩵", Wd = "=", Zd = "≂", Jd = "≟", Qd = "⇌", Yd = "≡", Xd = "⩸", Kd = "⧥", ef = "⥱", nf = "≓", tf = "ℯ", of = "ℰ", sf = "≐", rf = "⩳", cf = "≂", af = "Η", lf = "η", uf = "Ð", pf = "ð", hf = "Ë", df = "ë", ff = "€", mf = "!", gf = "∃", _f = "∃", bf = "ℰ", kf = "ⅇ", wf = "ⅇ", yf = "≒", vf = "Ф", xf = "ф", Af = "♀", Sf = "ﬃ", Lf = "ﬀ", Cf = "ﬄ", Ef = "𝔉", Tf = "𝔣", Df = "ﬁ", qf = "◼", jf = "▪", Rf = "fj", Nf = "♭", Pf = "ﬂ", If = "▱", Of = "ƒ", Ff = "𝔽", Mf = "𝕗", Bf = "∀", $f = "∀", zf = "⋔", Gf = "⫙", Uf = "ℱ", Hf = "⨍", Vf = "½", Wf = "⅓", Zf = "¼", Jf = "⅕", Qf = "⅙", Yf = "⅛", Xf = "⅔", Kf = "⅖", em = "¾", nm = "⅗", tm = "⅜", om = "⅘", sm = "⅚", rm = "⅝", cm = "⅞", am = "⁄", im = "⌢", lm = "𝒻", um = "ℱ", pm = "ǵ", hm = "Γ", dm = "γ", fm = "Ϝ", mm = "ϝ", gm = "⪆", _m = "Ğ", bm = "ğ", km = "Ģ", wm = "Ĝ", ym = "ĝ", vm = "Г", xm = "г", Am = "Ġ", Sm = "ġ", Lm = "≥", Cm = "≧", Em = "⪌", Tm = "⋛", Dm = "≥", qm = "≧", jm = "⩾", Rm = "⪩", Nm = "⩾", Pm = "⪀", Im = "⪂", Om = "⪄", Fm = "⋛︀", Mm = "⪔", Bm = "𝔊", $m = "𝔤", zm = "≫", Gm = "⋙", Um = "⋙", Hm = "ℷ", Vm = "Ѓ", Wm = "ѓ", Zm = "⪥", Jm = "≷", Qm = "⪒", Ym = "⪤", Xm = "⪊", Km = "⪊", eg = "⪈", ng = "≩", tg = "⪈", og = "≩", sg = "⋧", rg = "𝔾", cg = "𝕘", ag = "`", ig = "≥", lg = "⋛", ug = "≧", pg = "⪢", hg = "≷", dg = "⩾", fg = "≳", mg = "𝒢", gg = "ℊ", _g = "≳", bg = "⪎", kg = "⪐", wg = "⪧", yg = "⩺", vg = ">", xg = ">", Ag = "≫", Sg = "⋗", Lg = "⦕", Cg = "⩼", Eg = "⪆", Tg = "⥸", Dg = "⋗", qg = "⋛", jg = "⪌", Rg = "≷", Ng = "≳", Pg = "≩︀", Ig = "≩︀", Og = "ˇ", Fg = " ", Mg = "½", Bg = "ℋ", $g = "Ъ", zg = "ъ", Gg = "⥈", Ug = "↔", Hg = "⇔", Vg = "↭", Wg = "^", Zg = "ℏ", Jg = "Ĥ", Qg = "ĥ", Yg = "♥", Xg = "♥", Kg = "…", e_ = "⊹", n_ = "𝔥", t_ = "ℌ", o_ = "ℋ", s_ = "⤥", r_ = "⤦", c_ = "⇿", a_ = "∻", i_ = "↩", l_ = "↪", u_ = "𝕙", p_ = "ℍ", h_ = "―", d_ = "─", f_ = "𝒽", m_ = "ℋ", g_ = "ℏ", __ = "Ħ", b_ = "ħ", k_ = "≎", w_ = "≏", y_ = "⁃", v_ = "‐", x_ = "Í", A_ = "í", S_ = "⁣", L_ = "Î", C_ = "î", E_ = "И", T_ = "и", D_ = "İ", q_ = "Е", j_ = "е", R_ = "¡", N_ = "⇔", P_ = "𝔦", I_ = "ℑ", O_ = "Ì", F_ = "ì", M_ = "ⅈ", B_ = "⨌", $_ = "∭", z_ = "⧜", G_ = "℩", U_ = "Ĳ", H_ = "ĳ", V_ = "Ī", W_ = "ī", Z_ = "ℑ", J_ = "ⅈ", Q_ = "ℐ", Y_ = "ℑ", X_ = "ı", K_ = "ℑ", eb = "⊷", nb = "Ƶ", tb = "⇒", ob = "℅", sb = "∞", rb = "⧝", cb = "ı", ab = "⊺", ib = "∫", lb = "∬", ub = "ℤ", pb = "∫", hb = "⊺", db = "⋂", fb = "⨗", mb = "⨼", gb = "⁣", _b = "⁢", bb = "Ё", kb = "ё", wb = "Į", yb = "į", vb = "𝕀", xb = "𝕚", Ab = "Ι", Sb = "ι", Lb = "⨼", Cb = "¿", Eb = "𝒾", Tb = "ℐ", Db = "∈", qb = "⋵", jb = "⋹", Rb = "⋴", Nb = "⋳", Pb = "∈", Ib = "⁢", Ob = "Ĩ", Fb = "ĩ", Mb = "І", Bb = "і", $b = "Ï", zb = "ï", Gb = "Ĵ", Ub = "ĵ", Hb = "Й", Vb = "й", Wb = "𝔍", Zb = "𝔧", Jb = "ȷ", Qb = "𝕁", Yb = "𝕛", Xb = "𝒥", Kb = "𝒿", ek = "Ј", nk = "ј", tk = "Є", ok = "є", sk = "Κ", rk = "κ", ck = "ϰ", ak = "Ķ", ik = "ķ", lk = "К", uk = "к", pk = "𝔎", hk = "𝔨", dk = "ĸ", fk = "Х", mk = "х", gk = "Ќ", _k = "ќ", bk = "𝕂", kk = "𝕜", wk = "𝒦", yk = "𝓀", vk = "⇚", xk = "Ĺ", Ak = "ĺ", Sk = "⦴", Lk = "ℒ", Ck = "Λ", Ek = "λ", Tk = "⟨", Dk = "⟪", qk = "⦑", jk = "⟨", Rk = "⪅", Nk = "ℒ", Pk = "«", Ik = "⇤", Ok = "⤟", Fk = "←", Mk = "↞", Bk = "⇐", $k = "⤝", zk = "↩", Gk = "↫", Uk = "⤹", Hk = "⥳", Vk = "↢", Wk = "⤙", Zk = "⤛", Jk = "⪫", Qk = "⪭", Yk = "⪭︀", Xk = "⤌", Kk = "⤎", ew = "❲", nw = "{", tw = "[", ow = "⦋", sw = "⦏", rw = "⦍", cw = "Ľ", aw = "ľ", iw = "Ļ", lw = "ļ", uw = "⌈", pw = "{", hw = "Л", dw = "л", fw = "⤶", mw = "“", gw = "„", _w = "⥧", bw = "⥋", kw = "↲", ww = "≤", yw = "≦", vw = "⟨", xw = "⇤", Aw = "←", Sw = "←", Lw = "⇐", Cw = "⇆", Ew = "↢", Tw = "⌈", Dw = "⟦", qw = "⥡", jw = "⥙", Rw = "⇃", Nw = "⌊", Pw = "↽", Iw = "↼", Ow = "⇇", Fw = "↔", Mw = "↔", Bw = "⇔", $w = "⇆", zw = "⇋", Gw = "↭", Uw = "⥎", Hw = "↤", Vw = "⊣", Ww = "⥚", Zw = "⋋", Jw = "⧏", Qw = "⊲", Yw = "⊴", Xw = "⥑", Kw = "⥠", ey = "⥘", ny = "↿", ty = "⥒", oy = "↼", sy = "⪋", ry = "⋚", cy = "≤", ay = "≦", iy = "⩽", ly = "⪨", uy = "⩽", py = "⩿", hy = "⪁", dy = "⪃", fy = "⋚︀", my = "⪓", gy = "⪅", _y = "⋖", by = "⋚", ky = "⪋", wy = "⋚", yy = "≦", vy = "≶", xy = "≶", Ay = "⪡", Sy = "≲", Ly = "⩽", Cy = "≲", Ey = "⥼", Ty = "⌊", Dy = "𝔏", qy = "𝔩", jy = "≶", Ry = "⪑", Ny = "⥢", Py = "↽", Iy = "↼", Oy = "⥪", Fy = "▄", My = "Љ", By = "љ", $y = "⇇", zy = "≪", Gy = "⋘", Uy = "⌞", Hy = "⇚", Vy = "⥫", Wy = "◺", Zy = "Ŀ", Jy = "ŀ", Qy = "⎰", Yy = "⎰", Xy = "⪉", Ky = "⪉", e0 = "⪇", n0 = "≨", t0 = "⪇", o0 = "≨", s0 = "⋦", r0 = "⟬", c0 = "⇽", a0 = "⟦", i0 = "⟵", l0 = "⟵", u0 = "⟸", p0 = "⟷", h0 = "⟷", d0 = "⟺", f0 = "⟼", m0 = "⟶", g0 = "⟶", _0 = "⟹", b0 = "↫", k0 = "↬", w0 = "⦅", y0 = "𝕃", v0 = "𝕝", x0 = "⨭", A0 = "⨴", S0 = "∗", L0 = "_", C0 = "↙", E0 = "↘", T0 = "◊", D0 = "◊", q0 = "⧫", j0 = "(", R0 = "⦓", N0 = "⇆", P0 = "⌟", I0 = "⇋", O0 = "⥭", F0 = "‎", M0 = "⊿", B0 = "‹", $0 = "𝓁", z0 = "ℒ", G0 = "↰", U0 = "↰", H0 = "≲", V0 = "⪍", W0 = "⪏", Z0 = "[", J0 = "‘", Q0 = "‚", Y0 = "Ł", X0 = "ł", K0 = "⪦", ev = "⩹", nv = "<", tv = "<", ov = "≪", sv = "⋖", rv = "⋋", cv = "⋉", av = "⥶", iv = "⩻", lv = "◃", uv = "⊴", pv = "◂", hv = "⦖", dv = "⥊", fv = "⥦", mv = "≨︀", gv = "≨︀", _v = "¯", bv = "♂", kv = "✠", wv = "✠", yv = "↦", vv = "↦", xv = "↧", Av = "↤", Sv = "↥", Lv = "▮", Cv = "⨩", Ev = "М", Tv = "м", Dv = "—", qv = "∺", jv = "∡", Rv = " ", Nv = "ℳ", Pv = "𝔐", Iv = "𝔪", Ov = "℧", Fv = "µ", Mv = "*", Bv = "⫰", $v = "∣", zv = "·", Gv = "⊟", Uv = "−", Hv = "∸", Vv = "⨪", Wv = "∓", Zv = "⫛", Jv = "…", Qv = "∓", Yv = "⊧", Xv = "𝕄", Kv = "𝕞", e1 = "∓", n1 = "𝓂", t1 = "ℳ", o1 = "∾", s1 = "Μ", r1 = "μ", c1 = "⊸", a1 = "⊸", i1 = "∇", l1 = "Ń", u1 = "ń", p1 = "∠⃒", h1 = "≉", d1 = "⩰̸", f1 = "≋̸", m1 = "ŉ", g1 = "≉", _1 = "♮", b1 = "ℕ", k1 = "♮", w1 = " ", y1 = "≎̸", v1 = "≏̸", x1 = "⩃", A1 = "Ň", S1 = "ň", L1 = "Ņ", C1 = "ņ", E1 = "≇", T1 = "⩭̸", D1 = "⩂", q1 = "Н", j1 = "н", R1 = "–", N1 = "⤤", P1 = "↗", I1 = "⇗", O1 = "↗", F1 = "≠", M1 = "≐̸", B1 = "​", $1 = "​", z1 = "​", G1 = "​", U1 = "≢", H1 = "⤨", V1 = "≂̸", W1 = "≫", Z1 = "≪", J1 = `
`, Q1 = "∄", Y1 = "∄", X1 = "𝔑", K1 = "𝔫", ex = "≧̸", nx = "≱", tx = "≱", ox = "≧̸", sx = "⩾̸", rx = "⩾̸", cx = "⋙̸", ax = "≵", ix = "≫⃒", lx = "≯", ux = "≯", px = "≫̸", hx = "↮", dx = "⇎", fx = "⫲", mx = "∋", gx = "⋼", _x = "⋺", bx = "∋", kx = "Њ", wx = "њ", yx = "↚", vx = "⇍", xx = "‥", Ax = "≦̸", Sx = "≰", Lx = "↚", Cx = "⇍", Ex = "↮", Tx = "⇎", Dx = "≰", qx = "≦̸", jx = "⩽̸", Rx = "⩽̸", Nx = "≮", Px = "⋘̸", Ix = "≴", Ox = "≪⃒", Fx = "≮", Mx = "⋪", Bx = "⋬", $x = "≪̸", zx = "∤", Gx = "⁠", Ux = " ", Hx = "𝕟", Vx = "ℕ", Wx = "⫬", Zx = "¬", Jx = "≢", Qx = "≭", Yx = "∦", Xx = "∉", Kx = "≠", eA = "≂̸", nA = "∄", tA = "≯", oA = "≱", sA = "≧̸", rA = "≫̸", cA = "≹", aA = "⩾̸", iA = "≵", lA = "≎̸", uA = "≏̸", pA = "∉", hA = "⋵̸", dA = "⋹̸", fA = "∉", mA = "⋷", gA = "⋶", _A = "⧏̸", bA = "⋪", kA = "⋬", wA = "≮", yA = "≰", vA = "≸", xA = "≪̸", AA = "⩽̸", SA = "≴", LA = "⪢̸", CA = "⪡̸", EA = "∌", TA = "∌", DA = "⋾", qA = "⋽", jA = "⊀", RA = "⪯̸", NA = "⋠", PA = "∌", IA = "⧐̸", OA = "⋫", FA = "⋭", MA = "⊏̸", BA = "⋢", $A = "⊐̸", zA = "⋣", GA = "⊂⃒", UA = "⊈", HA = "⊁", VA = "⪰̸", WA = "⋡", ZA = "≿̸", JA = "⊃⃒", QA = "⊉", YA = "≁", XA = "≄", KA = "≇", eS = "≉", nS = "∤", tS = "∦", oS = "∦", sS = "⫽⃥", rS = "∂̸", cS = "⨔", aS = "⊀", iS = "⋠", lS = "⊀", uS = "⪯̸", pS = "⪯̸", hS = "⤳̸", dS = "↛", fS = "⇏", mS = "↝̸", gS = "↛", _S = "⇏", bS = "⋫", kS = "⋭", wS = "⊁", yS = "⋡", vS = "⪰̸", xS = "𝒩", AS = "𝓃", SS = "∤", LS = "∦", CS = "≁", ES = "≄", TS = "≄", DS = "∤", qS = "∦", jS = "⋢", RS = "⋣", NS = "⊄", PS = "⫅̸", IS = "⊈", OS = "⊂⃒", FS = "⊈", MS = "⫅̸", BS = "⊁", $S = "⪰̸", zS = "⊅", GS = "⫆̸", US = "⊉", HS = "⊃⃒", VS = "⊉", WS = "⫆̸", ZS = "≹", JS = "Ñ", QS = "ñ", YS = "≸", XS = "⋪", KS = "⋬", eL = "⋫", nL = "⋭", tL = "Ν", oL = "ν", sL = "#", rL = "№", cL = " ", aL = "≍⃒", iL = "⊬", lL = "⊭", uL = "⊮", pL = "⊯", hL = "≥⃒", dL = ">⃒", fL = "⤄", mL = "⧞", gL = "⤂", _L = "≤⃒", bL = "<⃒", kL = "⊴⃒", wL = "⤃", yL = "⊵⃒", vL = "∼⃒", xL = "⤣", AL = "↖", SL = "⇖", LL = "↖", CL = "⤧", EL = "Ó", TL = "ó", DL = "⊛", qL = "Ô", jL = "ô", RL = "⊚", NL = "О", PL = "о", IL = "⊝", OL = "Ő", FL = "ő", ML = "⨸", BL = "⊙", $L = "⦼", zL = "Œ", GL = "œ", UL = "⦿", HL = "𝔒", VL = "𝔬", WL = "˛", ZL = "Ò", JL = "ò", QL = "⧁", YL = "⦵", XL = "Ω", KL = "∮", eC = "↺", nC = "⦾", tC = "⦻", oC = "‾", sC = "⧀", rC = "Ō", cC = "ō", aC = "Ω", iC = "ω", lC = "Ο", uC = "ο", pC = "⦶", hC = "⊖", dC = "𝕆", fC = "𝕠", mC = "⦷", gC = "“", _C = "‘", bC = "⦹", kC = "⊕", wC = "↻", yC = "⩔", vC = "∨", xC = "⩝", AC = "ℴ", SC = "ℴ", LC = "ª", CC = "º", EC = "⊶", TC = "⩖", DC = "⩗", qC = "⩛", jC = "Ⓢ", RC = "𝒪", NC = "ℴ", PC = "Ø", IC = "ø", OC = "⊘", FC = "Õ", MC = "õ", BC = "⨶", $C = "⨷", zC = "⊗", GC = "Ö", UC = "ö", HC = "⌽", VC = "‾", WC = "⏞", ZC = "⎴", JC = "⏜", QC = "¶", YC = "∥", XC = "∥", KC = "⫳", eE = "⫽", nE = "∂", tE = "∂", oE = "П", sE = "п", rE = "%", cE = ".", aE = "‰", iE = "⊥", lE = "‱", uE = "𝔓", pE = "𝔭", hE = "Φ", dE = "φ", fE = "ϕ", mE = "ℳ", gE = "☎", _E = "Π", bE = "π", kE = "⋔", wE = "ϖ", yE = "ℏ", vE = "ℎ", xE = "ℏ", AE = "⨣", SE = "⊞", LE = "⨢", CE = "+", EE = "∔", TE = "⨥", DE = "⩲", qE = "±", jE = "±", RE = "⨦", NE = "⨧", PE = "±", IE = "ℌ", OE = "⨕", FE = "𝕡", ME = "ℙ", BE = "£", $E = "⪷", zE = "⪻", GE = "≺", UE = "≼", HE = "⪷", VE = "≺", WE = "≼", ZE = "≺", JE = "⪯", QE = "≼", YE = "≾", XE = "⪯", KE = "⪹", eT = "⪵", nT = "⋨", tT = "⪯", oT = "⪳", sT = "≾", rT = "′", cT = "″", aT = "ℙ", iT = "⪹", lT = "⪵", uT = "⋨", pT = "∏", hT = "∏", dT = "⌮", fT = "⌒", mT = "⌓", gT = "∝", _T = "∝", bT = "∷", kT = "∝", wT = "≾", yT = "⊰", vT = "𝒫", xT = "𝓅", AT = "Ψ", ST = "ψ", LT = " ", CT = "𝔔", ET = "𝔮", TT = "⨌", DT = "𝕢", qT = "ℚ", jT = "⁗", RT = "𝒬", NT = "𝓆", PT = "ℍ", IT = "⨖", OT = "?", FT = "≟", MT = '"', BT = '"', $T = "⇛", zT = "∽̱", GT = "Ŕ", UT = "ŕ", HT = "√", VT = "⦳", WT = "⟩", ZT = "⟫", JT = "⦒", QT = "⦥", YT = "⟩", XT = "»", KT = "⥵", eD = "⇥", nD = "⤠", tD = "⤳", oD = "→", sD = "↠", rD = "⇒", cD = "⤞", aD = "↪", iD = "↬", lD = "⥅", uD = "⥴", pD = "⤖", hD = "↣", dD = "↝", fD = "⤚", mD = "⤜", gD = "∶", _D = "ℚ", bD = "⤍", kD = "⤏", wD = "⤐", yD = "❳", vD = "}", xD = "]", AD = "⦌", SD = "⦎", LD = "⦐", CD = "Ř", ED = "ř", TD = "Ŗ", DD = "ŗ", qD = "⌉", jD = "}", RD = "Р", ND = "р", PD = "⤷", ID = "⥩", OD = "”", FD = "”", MD = "↳", BD = "ℜ", $D = "ℛ", zD = "ℜ", GD = "ℝ", UD = "ℜ", HD = "▭", VD = "®", WD = "®", ZD = "∋", JD = "⇋", QD = "⥯", YD = "⥽", XD = "⌋", KD = "𝔯", eq = "ℜ", nq = "⥤", tq = "⇁", oq = "⇀", sq = "⥬", rq = "Ρ", cq = "ρ", aq = "ϱ", iq = "⟩", lq = "⇥", uq = "→", pq = "→", hq = "⇒", dq = "⇄", fq = "↣", mq = "⌉", gq = "⟧", _q = "⥝", bq = "⥕", kq = "⇂", wq = "⌋", yq = "⇁", vq = "⇀", xq = "⇄", Aq = "⇌", Sq = "⇉", Lq = "↝", Cq = "↦", Eq = "⊢", Tq = "⥛", Dq = "⋌", qq = "⧐", jq = "⊳", Rq = "⊵", Nq = "⥏", Pq = "⥜", Iq = "⥔", Oq = "↾", Fq = "⥓", Mq = "⇀", Bq = "˚", $q = "≓", zq = "⇄", Gq = "⇌", Uq = "‏", Hq = "⎱", Vq = "⎱", Wq = "⫮", Zq = "⟭", Jq = "⇾", Qq = "⟧", Yq = "⦆", Xq = "𝕣", Kq = "ℝ", ej = "⨮", nj = "⨵", tj = "⥰", oj = ")", sj = "⦔", rj = "⨒", cj = "⇉", aj = "⇛", ij = "›", lj = "𝓇", uj = "ℛ", pj = "↱", hj = "↱", dj = "]", fj = "’", mj = "’", gj = "⋌", _j = "⋊", bj = "▹", kj = "⊵", wj = "▸", yj = "⧎", vj = "⧴", xj = "⥨", Aj = "℞", Sj = "Ś", Lj = "ś", Cj = "‚", Ej = "⪸", Tj = "Š", Dj = "š", qj = "⪼", jj = "≻", Rj = "≽", Nj = "⪰", Pj = "⪴", Ij = "Ş", Oj = "ş", Fj = "Ŝ", Mj = "ŝ", Bj = "⪺", $j = "⪶", zj = "⋩", Gj = "⨓", Uj = "≿", Hj = "С", Vj = "с", Wj = "⊡", Zj = "⋅", Jj = "⩦", Qj = "⤥", Yj = "↘", Xj = "⇘", Kj = "↘", e2 = "§", n2 = ";", t2 = "⤩", o2 = "∖", s2 = "∖", r2 = "✶", c2 = "𝔖", a2 = "𝔰", i2 = "⌢", l2 = "♯", u2 = "Щ", p2 = "щ", h2 = "Ш", d2 = "ш", f2 = "↓", m2 = "←", g2 = "∣", _2 = "∥", b2 = "→", k2 = "↑", w2 = "­", y2 = "Σ", v2 = "σ", x2 = "ς", A2 = "ς", S2 = "∼", L2 = "⩪", C2 = "≃", E2 = "≃", T2 = "⪞", D2 = "⪠", q2 = "⪝", j2 = "⪟", R2 = "≆", N2 = "⨤", P2 = "⥲", I2 = "←", O2 = "∘", F2 = "∖", M2 = "⨳", B2 = "⧤", $2 = "∣", z2 = "⌣", G2 = "⪪", U2 = "⪬", H2 = "⪬︀", V2 = "Ь", W2 = "ь", Z2 = "⌿", J2 = "⧄", Q2 = "/", Y2 = "𝕊", X2 = "𝕤", K2 = "♠", eR = "♠", nR = "∥", tR = "⊓", oR = "⊓︀", sR = "⊔", rR = "⊔︀", cR = "√", aR = "⊏", iR = "⊑", lR = "⊏", uR = "⊑", pR = "⊐", hR = "⊒", dR = "⊐", fR = "⊒", mR = "□", gR = "□", _R = "⊓", bR = "⊏", kR = "⊑", wR = "⊐", yR = "⊒", vR = "⊔", xR = "▪", AR = "□", SR = "▪", LR = "→", CR = "𝒮", ER = "𝓈", TR = "∖", DR = "⌣", qR = "⋆", jR = "⋆", RR = "☆", NR = "★", PR = "ϵ", IR = "ϕ", OR = "¯", FR = "⊂", MR = "⋐", BR = "⪽", $R = "⫅", zR = "⊆", GR = "⫃", UR = "⫁", HR = "⫋", VR = "⊊", WR = "⪿", ZR = "⥹", JR = "⊂", QR = "⋐", YR = "⊆", XR = "⫅", KR = "⊆", eN = "⊊", nN = "⫋", tN = "⫇", oN = "⫕", sN = "⫓", rN = "⪸", cN = "≻", aN = "≽", iN = "≻", lN = "⪰", uN = "≽", pN = "≿", hN = "⪰", dN = "⪺", fN = "⪶", mN = "⋩", gN = "≿", _N = "∋", bN = "∑", kN = "∑", wN = "♪", yN = "¹", vN = "²", xN = "³", AN = "⊃", SN = "⋑", LN = "⪾", CN = "⫘", EN = "⫆", TN = "⊇", DN = "⫄", qN = "⊃", jN = "⊇", RN = "⟉", NN = "⫗", PN = "⥻", IN = "⫂", ON = "⫌", FN = "⊋", MN = "⫀", BN = "⊃", $N = "⋑", zN = "⊇", GN = "⫆", UN = "⊋", HN = "⫌", VN = "⫈", WN = "⫔", ZN = "⫖", JN = "⤦", QN = "↙", YN = "⇙", XN = "↙", KN = "⤪", eP = "ß", nP = "	", tP = "⌖", oP = "Τ", sP = "τ", rP = "⎴", cP = "Ť", aP = "ť", iP = "Ţ", lP = "ţ", uP = "Т", pP = "т", hP = "⃛", dP = "⌕", fP = "𝔗", mP = "𝔱", gP = "∴", _P = "∴", bP = "∴", kP = "Θ", wP = "θ", yP = "ϑ", vP = "ϑ", xP = "≈", AP = "∼", SP = "  ", LP = " ", CP = " ", EP = "≈", TP = "∼", DP = "Þ", qP = "þ", jP = "˜", RP = "∼", NP = "≃", PP = "≅", IP = "≈", OP = "⨱", FP = "⊠", MP = "×", BP = "⨰", $P = "∭", zP = "⤨", GP = "⌶", UP = "⫱", HP = "⊤", VP = "𝕋", WP = "𝕥", ZP = "⫚", JP = "⤩", QP = "‴", YP = "™", XP = "™", KP = "▵", eI = "▿", nI = "◃", tI = "⊴", oI = "≜", sI = "▹", rI = "⊵", cI = "◬", aI = "≜", iI = "⨺", lI = "⃛", uI = "⨹", pI = "⧍", hI = "⨻", dI = "⏢", fI = "𝒯", mI = "𝓉", gI = "Ц", _I = "ц", bI = "Ћ", kI = "ћ", wI = "Ŧ", yI = "ŧ", vI = "≬", xI = "↞", AI = "↠", SI = "Ú", LI = "ú", CI = "↑", EI = "↟", TI = "⇑", DI = "⥉", qI = "Ў", jI = "ў", RI = "Ŭ", NI = "ŭ", PI = "Û", II = "û", OI = "У", FI = "у", MI = "⇅", BI = "Ű", $I = "ű", zI = "⥮", GI = "⥾", UI = "𝔘", HI = "𝔲", VI = "Ù", WI = "ù", ZI = "⥣", JI = "↿", QI = "↾", YI = "▀", XI = "⌜", KI = "⌜", eO = "⌏", nO = "◸", tO = "Ū", oO = "ū", sO = "¨", rO = "_", cO = "⏟", aO = "⎵", iO = "⏝", lO = "⋃", uO = "⊎", pO = "Ų", hO = "ų", dO = "𝕌", fO = "𝕦", mO = "⤒", gO = "↑", _O = "↑", bO = "⇑", kO = "⇅", wO = "↕", yO = "↕", vO = "⇕", xO = "⥮", AO = "↿", SO = "↾", LO = "⊎", CO = "↖", EO = "↗", TO = "υ", DO = "ϒ", qO = "ϒ", jO = "Υ", RO = "υ", NO = "↥", PO = "⊥", IO = "⇈", OO = "⌝", FO = "⌝", MO = "⌎", BO = "Ů", $O = "ů", zO = "◹", GO = "𝒰", UO = "𝓊", HO = "⋰", VO = "Ũ", WO = "ũ", ZO = "▵", JO = "▴", QO = "⇈", YO = "Ü", XO = "ü", KO = "⦧", eF = "⦜", nF = "ϵ", tF = "ϰ", oF = "∅", sF = "ϕ", rF = "ϖ", cF = "∝", aF = "↕", iF = "⇕", lF = "ϱ", uF = "ς", pF = "⊊︀", hF = "⫋︀", dF = "⊋︀", fF = "⫌︀", mF = "ϑ", gF = "⊲", _F = "⊳", bF = "⫨", kF = "⫫", wF = "⫩", yF = "В", vF = "в", xF = "⊢", AF = "⊨", SF = "⊩", LF = "⊫", CF = "⫦", EF = "⊻", TF = "∨", DF = "⋁", qF = "≚", jF = "⋮", RF = "|", NF = "‖", PF = "|", IF = "‖", OF = "∣", FF = "|", MF = "❘", BF = "≀", $F = " ", zF = "𝔙", GF = "𝔳", UF = "⊲", HF = "⊂⃒", VF = "⊃⃒", WF = "𝕍", ZF = "𝕧", JF = "∝", QF = "⊳", YF = "𝒱", XF = "𝓋", KF = "⫋︀", e3 = "⊊︀", n3 = "⫌︀", t3 = "⊋︀", o3 = "⊪", s3 = "⦚", r3 = "Ŵ", c3 = "ŵ", a3 = "⩟", i3 = "∧", l3 = "⋀", u3 = "≙", p3 = "℘", h3 = "𝔚", d3 = "𝔴", f3 = "𝕎", m3 = "𝕨", g3 = "℘", _3 = "≀", b3 = "≀", k3 = "𝒲", w3 = "𝓌", y3 = "⋂", v3 = "◯", x3 = "⋃", A3 = "▽", S3 = "𝔛", L3 = "𝔵", C3 = "⟷", E3 = "⟺", T3 = "Ξ", D3 = "ξ", q3 = "⟵", j3 = "⟸", R3 = "⟼", N3 = "⋻", P3 = "⨀", I3 = "𝕏", O3 = "𝕩", F3 = "⨁", M3 = "⨂", B3 = "⟶", $3 = "⟹", z3 = "𝒳", G3 = "𝓍", U3 = "⨆", H3 = "⨄", V3 = "△", W3 = "⋁", Z3 = "⋀", J3 = "Ý", Q3 = "ý", Y3 = "Я", X3 = "я", K3 = "Ŷ", eM = "ŷ", nM = "Ы", tM = "ы", oM = "¥", sM = "𝔜", rM = "𝔶", cM = "Ї", aM = "ї", iM = "𝕐", lM = "𝕪", uM = "𝒴", pM = "𝓎", hM = "Ю", dM = "ю", fM = "ÿ", mM = "Ÿ", gM = "Ź", _M = "ź", bM = "Ž", kM = "ž", wM = "З", yM = "з", vM = "Ż", xM = "ż", AM = "ℨ", SM = "​", LM = "Ζ", CM = "ζ", EM = "𝔷", TM = "ℨ", DM = "Ж", qM = "ж", jM = "⇝", RM = "𝕫", NM = "ℤ", PM = "𝒵", IM = "𝓏", OM = "‍", FM = "‌", MM = {
  Aacute: ys,
  aacute: vs,
  Abreve: xs,
  abreve: As,
  ...
  LeftArrow: Sw,
  Leftarrow: Lw,
  LeftArrowRightArrow: Cw,
  leftarrowtail: Ew,
  LeftCeiling: Tw,
  LeftDoubleBracket: Dw,
  LeftDownTeeVector: qw,
  ...
  Leftrightarrow: Bw,
  leftrightarrows: $w,
  leftrightharpoons: zw,
  leftrightsquigarrow: Gw,
  LeftRightVector: Uw,
  LeftTeeArrow: Hw,
  LeftTee: Vw,
  LeftTeeVector: Ww,
...
`, "	"], JM = ["{", "}", "|", "\\", "^", "`"].concat(ZM), QM = ["'"].concat(JM), _t = ["%", "/", "?", ";", "#"].concat(QM), bt = ["/", "?", "#"], YM = 255, kt = /^[+a-z0-9A-Z_-]{0,63}$/, XM = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, wt = {
  javascript: !0,
  "javascript:": !0
}, yt = {
  http: !0,
...
rn.prototype.parse = function(n, e) {
  ...
  var i = HM.exec(c);
  if (i && (i = i[0], r = i.toLowerCase(), this.protocol = i, c = c.substr(i.length)), (e || i || c.match(/^\/\/[^@\/]+@[^@\/]+/)) && (a = c.substr(0, 2) === "//", a && !(i && wt[i]) && (c = c.substr(2), this.slashes = !0)), !wt[i] && (a || i && !yt[i])) {
    var p = -1;
    ...
    if (!m) {
      ...
      for (t = 0, o = L.length; t < o; t++) {
        var S = L[t];
        if (S && !S.match(kt)) {
          for (var b = "", k = 0, y = S.length; k < y; k++)
            S.charCodeAt(k) > 127 ? b += "x" : b += S[k];
          if (!b.match(kt)) {
            var C = L.slice(0, t), w = L.slice(t + 1), u = S.match(XM);
            u && (C.push(u[1]), w.unshift(u[2])), w.length && (c = w.join(".") + c), this.hostname = C.join(".");
            break;
          }
        }
      }
...
var Lt;
function tB() {
  return Lt || (Lt = 1, Ce.Any = bo(), Ce.Cc = ko(), Ce.Cf = nB(), Ce.P = et, Ce.Z = wo()), Ce;
}
(function(n) {
  function e(T) {
  ...
  n.lib = {}, n.lib.mdurl = ze, n.lib.ucmicro = tB(), n.assign = s, n.isString = t, n.has = r, n.unescapeMd = L, n.unescapeAll = S, n.isValidEntityCode = c, n.fromCodePoint = l, n.escapeHtml = w, n.arrayReplaceAt = a, n.isSpace = x, n.isWhiteSpace = _, n.isMdAsciiPunct = E, n.isPunctChar = A, n.escapeRE = g, n.normalizeReference = D;
})(B);
...
var bB = function(e) {
  var t, o, r, s, a, c, l, i, p, h, d, f, m, L, S, b, k = e.tokens, y;
      ...
      if (!(k[o].type !== "inline" || !e.md.linkify.pretest(k[o].content)))
        for (s = k[o].children, m = 0, t = s.length - 1; t >= 0; t--) {
          ...
          if (c.type === "html_inline" && (gB(c.content) && m > 0 && m--, _B(c.content) && m++), !(m > 0) && c.type === "text" && e.md.linkify.test(c.content)) {
            for (p = c.content, y = e.md.linkify.match(p), l = [], f = c.level, d = 0, y.length > 0 && y[0].index === 0 && t > 0 && s[t - 1].type === "text_special" && (y = y.slice(1)), i = 0; i < y.length; i++)
              L = y[i].url, S = e.md.normalizeLink(L), e.md.validateLink(S) && (b = y[i].text, y[i].schema ? y[i].schema === "mailto:" && !/^mailto:/i.test(b) ? b = e.md.normalizeLinkText("mailto:" + b).replace(/^mailto:/, "") : b = e.md.normalizeLinkText(b) : b = e.md.normalizeLinkText("http://" + b).replace(/^http:\/\//, ""), h = y[i].index, h > d && (a = new e.Token("text", "", 0), a.content = p.slice(d, h), a.level = f, l.push(a)), a = new e.Token("link_open", "a", 1), a.attrs = [["href", S]], a.level = f++, a.markup = "linkify", a.info = "auto", l.push(a), a = new e.Token("text", "", 0), a.content = b, a.level = f, l.push(a), a = new e.Token("link_close", "a", -1), a.level = --f, a.markup = "linkify", a.info = "auto", l.push(a), d = y[i].lastIndex);
            d < p.length && (a = new e.Token("text", "", 0), a.content = p.slice(d), a.level = f, l.push(a)), k[o].children = s = mB(s, t, l);
          }
        }
  }
}, yo = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, kB = /\((c|tm|r)\)/i, wB = /\((c|tm|r)\)/ig, yB = {
  c: "©",
  r: "®",
  tm: "™"
};
...
function xB(n) {
  ...
  for (e = n.length - 1; e >= 0; e--)
    t = n[e], t.type === "text" && !o && (t.content = t.content.replace(wB, vB)), t.type === "link_open" && t.info === "auto" && o--, t.type === "link_close" && t.info === "auto" && o++;
}
function AB(n) {
  var e, t, o = 0;
  for (e = n.length - 1; e >= 0; e--)
    t = n[e], t.type === "text" && !o && yo.test(t.content) && (t.content = t.content.replace(/\+-/g, "±").replace(/\.{2,}/g, "…").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/mg, "$1—").replace(/(^|\s)--(?=\s|$)/mg, "$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg, "$1–")), t.type === "link_open" && t.info === "auto" && o--, t.type === "link_close" && t.info === "auto" && o++;
}
var SB = function(e) {
  var t;
  if (e.md.options.typographer)
    for (t = e.tokens.length - 1; t >= 0; t--)
      e.tokens[t].type === "inline" && (kB.test(e.tokens[t].content) && xB(e.tokens[t].children), yo.test(e.tokens[t].content) && AB(e.tokens[t].children));
}, Et = B.isWhiteSpace, Tt = B.isPunctChar, Dt = B.isMdAsciiPunct, LB = /['"]/, qt = /['"]/g, jt = "’";
function en(n, e, t) {
  return n.slice(0, e) + t + n.slice(e + 1);
}
function CB(n, e) {
  var t, o, r, s, a, c, l, i, p, h, d, f, m, L, S, b, k, y, C, w, u;
    ...
    if (C.length = k + 1, o.type === "text") {
      ...
      e:
        for (; a < c && (qt.lastIndex = a, s = qt.exec(r), !!s); ) {
          if (S = b = !0, a = s.index + 1, y = s[0] === "'", p = 32, s.index - 1 >= 0)
          ...
          if (d = Dt(p) || Tt(String.fromCharCode(p)), f = Dt(h) || Tt(String.fromCharCode(h)), m = Et(p), L = Et(h), L ? S = !1 : f && (m || d || (S = !1)), m ? b = !1 : d && (L || f || (b = !1)), h === 34 && s[0] === '"' && p >= 48 && p <= 57 && (b = S = !1), S && b && (S = d, b = f), !S && !b) {
            y && (o.content = en(o.content, s.index, jt));
            continue;
          }
          if (b) {
            for (k = C.length - 1; k >= 0 && (i = C[k], !(C[k].level < l)); k--)
              if (i.single === y && C[k].level === l) {
                i = C[k], y ? (w = e.md.options.quotes[2], u = e.md.options.quotes[3]) : (w = e.md.options.quotes[0], u = e.md.options.quotes[1]), o.content = en(o.content, s.index, u), n[i.token].content = en(
                  n[i.token].content,
                  i.pos,
                  w
                ), a += u.length - 1, i.token === t && (a += w.length - 1), r = o.content, c = r.length, C.length = k;
                continue e;
              }
          }
          S ? C.push({
            ...
            single: y,
            level: l
          }) : b && y && (o.content = en(o.content, s.index, jt));
        }
    }
  }
}
...
var NB = function(e, t, o, r) {
  var s, a, c, l, i, p, h, d, f, m, L, S, b, k, y, C, w, u;
  if (t + 2 > o || (p = t + 1, e.sCount[p] < e.blkIndent) || e.sCount[p] - e.blkIndent >= 4 || (c = e.bMarks[p] + e.tShift[p], c >= e.eMarks[p]) || (w = e.src.charCodeAt(c++), w !== 124 && w !== 45 && w !== 58) || c >= e.eMarks[p] || (u = e.src.charCodeAt(c++), u !== 124 && u !== 45 && u !== 58 && !qn(u)) || w === 45 && qn(u))
    return !1;
  for (; c < e.eMarks[p]; ) {
  ...
  for (f = e.push("tr_close", "tr", -1), f = e.push("thead_close", "thead", -1), p = t + 2; p < o && !(e.sCount[p] < e.blkIndent); p++) {
    for (y = !1, l = 0, i = C.length; l < i; l++)
      if (C[l](e, p, o, !0)) {
        y = !0;
        break;
      }
    if (y || (a = jn(e, p).trim(), !a) || e.sCount[p] - e.blkIndent >= 4)
      break;
...
`, a.map = [t, e.line], !0;
  ...
  var s, a, c, l, i, p, h, d, f, m, L, S, b, k, y, C, w, u, g, x, _ = e.lineMax, v = e.bMarks[t] + e.tShift[t], A = e.eMarks[t];
  ...
  for (L = [e.bsCount[t]], e.bsCount[t] = e.sCount[t] + 1 + (C ? 1 : 0), p = v >= A, k = [e.sCount[t]], e.sCount[t] = f - l, y = [e.tShift[t]], e.tShift[t] = v - e.bMarks[t], u = e.md.block.ruler.getRules("blockquote"), b = e.parentType, e.parentType = "blockquote", d = t + 1; d < o && (x = e.sCount[d] < e.blkIndent, v = e.bMarks[d] + e.tShift[d], A = e.eMarks[d], !(v >= A)); d++) {
    if (e.src.charCodeAt(v++) === 62 && !x) {
      ...
      p = v >= A, L.push(e.bsCount[d]), e.bsCount[d] = e.sCount[d] + 1 + (C ? 1 : 0), k.push(e.sCount[d]), e.sCount[d] = f - l, y.push(e.tShift[d]), e.tShift[d] = v - e.bMarks[d];
      continue;
    }
    if (p)
      break;
    for (w = !1, c = 0, i = u.length; c < i; c++)
      if (u[c](e, d, o, !0)) {
        w = !0;
        break;
      }
    if (w) {
      e.lineMax = d, e.blkIndent !== 0 && (m.push(e.bMarks[d]), L.push(e.bsCount[d]), y.push(e.tShift[d]), k.push(e.sCount[d]), e.sCount[d] -= e.blkIndent);
      break;
    }
    m.push(e.bMarks[d]), L.push(e.bsCount[d]), y.push(e.tShift[d]), k.push(e.sCount[d]), e.sCount[d] = -1;
  }
  for (S = e.blkIndent, e.blkIndent = 0, g = e.push("blockquote_open", "blockquote", 1), g.markup = ">", g.map = h = [t, 0], e.md.block.tokenize(e, t, d), g = e.push("blockquote_close", "blockquote", -1), g.markup = ">", e.lineMax = _, e.parentType = b, h[1] = e.line, c = 0; c < y.length; c++)
    e.bMarks[c + t] = m[c], e.tShift[c + t] = y[c], e.sCount[c + t] = k[c], e.bsCount[c + t] = L[c];
...
var $B = function(e, t, o, r) {
  var s, a, c, l, i, p, h, d, f, m, L, S, b, k, y, C, w, u, g, x, _, v, A, E, D, T, q, R, F = !1, M = !0;
  ...
  if (S = e.src.charCodeAt(A - 1), r)
    return !0;
  for (L = e.tokens.length, h ? (R = e.push("ordered_list_open", "ol", 1), b !== 1 && (R.attrs = [["start", b]])) : R = e.push("bullet_list_open", "ul", 1), R.map = m = [t, 0], R.markup = String.fromCharCode(S), y = t, E = !1, q = e.md.block.ruler.getRules("list"), u = e.parentType, e.parentType = "list"; y < o; ) {
    for (v = A, k = e.eMarks[y], p = C = e.sCount[y] + A - (e.bMarks[t] + e.tShift[t]); v < k; ) {
    ...
    if (a = v, a >= k ? i = 1 : i = C - p, i > 4 && (i = 1), l = p + i, R = e.push("list_item_open", "li", 1), R.markup = String.fromCharCode(S), R.map = d = [t, 0], h && (R.info = e.src.slice(D, A - 1)), _ = e.tight, x = e.tShift[t], g = e.sCount[t], w = e.listIndent, e.listIndent = e.blkIndent, e.blkIndent = l, e.tight = !0, e.tShift[t] = a - e.bMarks[t], e.sCount[t] = C, a >= k && e.isEmpty(t + 1) ? e.line = Math.min(e.line + 2, o) : e.md.block.tokenize(e, t, o, !0), (!e.tight || E) && (M = !1), E = e.line - t > 1 && e.isEmpty(e.line - 1), e.blkIndent = e.listIndent, e.listIndent = w, e.tShift[t] = x, e.sCount[t] = g, e.tight = _, R = e.push("list_item_close", "li", -1), R.markup = String.fromCharCode(S), y = t = e.line, d[1] = y, a = e.bMarks[t], y >= o || e.sCount[y] < e.blkIndent || e.sCount[t] - e.blkIndent >= 4)
      break;
    ...
    if (h) {
      if (A = It(e, y), A < 0)
        break;
      D = e.bMarks[y] + e.tShift[y];
    } else if (A = Pt(e, y), A < 0)
      break;
    if (S !== e.src.charCodeAt(A - 1))
      break;
  }
  return h ? R = e.push("ordered_list_close", "ol", -1) : R = e.push("bullet_list_close", "ul", -1), R.markup = String.fromCharCode(S), m[1] = y, e.line = y, e.parentType = u, M && BB(e, L), !0;
}, zB = B.normalizeReference, nn = B.isSpace, GB = function(e, t, o, r) {
  var s, a, c, l, i, p, h, d, f, m, L, S, b, k, y, C, w = 0, u = e.bMarks[t] + e.tShift[t], g = e.eMarks[t], x = t + 1;
  ...
  for (l = e.lineMax, y = e.md.block.ruler.getRules("reference"), m = e.parentType, e.parentType = "reference"; x < l && !e.isEmpty(x); x++)
    if (!(e.sCount[x] - e.blkIndent > 3) && !(e.sCount[x] < 0)) {
      for (k = !1, p = 0, h = y.length; p < h; p++)
        if (y[p](e, x, l, !0)) {
          k = !0;
          break;
        }
  ...
  for (b = e.getLines(t, x, e.blkIndent, !1).trim(), g = b.length, u = 1; u < g; u++) {
    ...
    if (s === 93) {
      ...
      s === 10 ? w++ : s === 92 && (u++, u < g && b.charCodeAt(u) === 10 && w++);
  }
  ...
  if (L = e.md.helpers.parseLinkDestination(b, u, g), !L.ok || (i = e.md.normalizeLink(L.str), !e.md.validateLink(i)))
    return !1;
  for (u = L.pos, w += L.lines, a = u, c = w, S = u; u < g; u++)
    if (s = b.charCodeAt(u), s === 10)
      w++;
    else if (!nn(s))
      break;
  for (L = e.md.helpers.parseLinkTitle(b, u, g), u < g && S !== u && L.ok ? (C = L.str, u = L.pos, w += L.lines) : (C = "", u = a, w = c); u < g && (s = b.charCodeAt(u), !!nn(s)); )
    u++;
  if (u < g && b.charCodeAt(u) !== 10 && C)
    for (C = "", u = a, w = c; u < g && (s = b.charCodeAt(u), !!nn(s)); )
      u++;
  return u < g && b.charCodeAt(u) !== 10 || (d = zB(b.slice(1, f)), !d) ? !1 : (r || (typeof e.env.references > "u" && (e.env.references = {}), typeof e.env.references[d] > "u" && (e.env.references[d] = { title: C, href: i }), e.parentType = m, e.line = t + w + 1), !0);
}, UB = [
  "address",
  "article",
  "aside",
...
wn.postProcess = function(e) {
  var t, o = e.tokens_meta, r = e.tokens_meta.length;
  for (Bt(e, e.delimiters), t = 0; t < r; t++)
    o[t] && o[t].delimiters && Bt(e, o[t].delimiters);
};
var y$ = B.normalizeReference, Rn = B.isSpace, v$ = function(e, t) {
  ...
  if (b) {
    if (typeof e.env.references > "u")
      return !1;
    if (l < L && e.src.charCodeAt(l) === 91 ? (S = l + 1, l = e.md.helpers.parseLinkLabel(e, l), l >= 0 ? s = e.src.slice(S, l++) : l = a + 1) : l = a + 1, s || (s = e.src.slice(c, a)), p = e.env.references[y$(s)], !p)
      return e.pos = m, !1;
    d = p.href, f = p.title;
  }
...
function z$() {
  return Zt || (Zt = 1, On = function(n) {
    var e = {};
    n = n || {}, e.src_Any = bo().source, e.src_Cc = ko().source, e.src_Z = wo().source, e.src_P = et.source, e.src_ZPCc = [e.src_Z, e.src_P, e.src_Cc].join("|"), e.src_ZCc = [e.src_Z, e.src_Cc].join("|");
    var t = "[><｜]";
...
const jo = (n) => String.fromCodePoint(...n), iz = function(n) {
  ...
  for (let c = a > 0 ? a + 1 : 0; c < t; ) {
    ...
    for (let p = 1, h = ue; ; h += ue) {
      ...
      d >= ue && ke("invalid-input"), d > pe((Be - o) / p) && ke("overflow"), o += d * p;
      const f = h <= s ? ct : h >= s + Je ? Je : h - s;
      if (d < f)
        break;
      const m = ue - f;
      p > pe(Be / m) && ke("overflow"), p *= m;
    }
    const i = e.length + 1;
    s = Ro(o - l, i, l == 0), pe(o / i) > Be - r && ke("overflow"), r += pe(o / i), o %= i, e.splice(o++, 0, r);
  }
  ...
  for (a && e.push(Do); c < t; ) {
    ...
    for (const p of n)
      p >= o && p < l && (l = p);
    const i = c + 1;
    l - o > pe((Be - r) / i) && ke("overflow"), r += (l - o) * i, o = l;
    for (const p of n)
      if (p < o && ++r > Be && ke("overflow"), p === o) {
        let h = r;
        for (let d = ue; ; d += ue) {
  ...
  ucs2decode: at,
  ucs2encode: jo
}, Symbol.toStringTag, { value: "Module" })), pz = /* @__PURE__ */ ws(uz);
var hz = {
  options: {
    html: !1,
...
}, Ze = B, mz = mn, gz = lB, _z = RB, bz = p$, kz = $$, wz = ez, Te = ze, Io = pz, yz = {
  default: hz,
  zero: dz,
  commonmark: fz
...
function Lz(n) {
  ...
  return Te.decode(Te.format(e), Te.decode.defaultChars + "%");
}
function ce(n, e) {
  if (!(this instanceof ce))
    return new ce(n, e);
  e || Ze.isString(n) || (e = n || {}, n = "default"), this.inline = new kz(), this.block = new bz(), this.core = new _z(), this.renderer = new gz(), this.linkify = new wz(), this.validateLink = Az, this.normalizeLink = Sz, this.normalizeLinkText = Lz, this.utils = Ze, this.helpers = Ze.assign({}, mz), this.options = {}, this.configure(n), e && this.set(e);
}
...
var Ee = Ke(vn.renderPermalinkImpl);
Ee.defaults = Object.assign({}, vn.defaults, { ariaHidden: !0 });
...
function De(n, e) {
  e = Object.assign({}, De.defaults, e), n.core.ruler.push("anchor", function(t) {
...
Object.assign(Kt.defaults, { style: "visually-hidden", space: !0, placement: "after", wrapper: null }), De.permalink = { __proto__: null, legacy: Jn, renderHref: Fo, renderAttrs: Mo, makePermalink: Ke, linkInsideHeader: vn, ariaHidden: Ee, headerLink: Bo, linkAfterHeader: Kt }, De.defaults = { level: 1, slugify: function(n) {
...
}, permalink: !1, renderPermalink: Jn, permalinkClass: Ee.defaults.class, permalinkSpace: Ee.defaults.space, permalinkSymbol: "¶", permalinkBefore: Ee.defaults.placement === "before", permalinkHref: Ee.defaults.renderHref, permalinkAttrs: Ee.defaults.renderAttrs }, De.default = De;
var ye = {};
...
const Gz = /* @__PURE__ */ hn(Fz), Uz = "😀", Hz = "😃", Vz = "😄", Wz = "😁", Zz = "😆", Jz = "😆", Qz = "😅", Yz = "🤣", Xz = "😂", Kz = "🙂", e5 = "🙃", n5 = "😉", t5 = "😊", o5 = "😇", s5 = "🥰", r5 = "😍", c5 = "🤩", a5 = "😘", i5 = "😗", l5 = "☺️", u5 = "😚", p5 = "😙", h5 = "🥲", d5 = "😋", f5 = "😛", m5 = "😜", g5 = "🤪", _5 = "😝", b5 = "🤑", k5 = "🤗", w5 = "🤭", y5 = "🤫", v5 = "🤔", x5 = "🤐", A5 = "🤨", S5 = "😐", L5 = "😑", C5 = "😶", E5 = "😏", T5 = "😒", D5 = "🙄", q5 = "😬", j5 = "🤥", R5 = "😌", N5 = "😔", P5 = "😪", I5 = "🤤", O5 = "😴", F5 = "😷", M5 = "🤒", B5 = "🤕", $5 = "🤢", z5 = "🤮", G5 = "🤧", U5 = "🥵", H5 = "🥶", V5 = "🥴", W5 = "😵", Z5 = "🤯", J5 = "🤠", Q5 = "🥳", Y5 = "🥸", X5 = "😎", K5 = "🤓", e6 = "🧐", n6 = "😕", t6 = "😟", o6 = "🙁", s6 = "☹️", r6 = "😮", c6 = "😯", a6 = "😲", i6 = "😳", l6 = "🥺", u6 = "😦", p6 = "😧", h6 = "😨", d6 = "😰", f6 = "😥", m6 = "😢", g6 = "😭", _6 = "😱", b6 = "😖", k6 = "😣", w6 = "😞", y6 = "😓", v6 = "😩", x6 = "😫", A6 = "🥱", S6 = "😤", L6 = "😡", C6 = "😡", E6 = "😠", T6 = "🤬", D6 = "😈", q6 = "👿", j6 = "💀", R6 = "☠️", N6 = "💩", P6 = "💩", I6 = "💩", O6 = "🤡", F6 = "👹", M6 = "👺", B6 = "👻", $6 = "👽", z6 = "👾", G6 = "🤖", U6 = "😺", H6 = "😸", V6 = "😹", W6 = "😻", Z6 = "😼", J6 = "😽", Q6 = "🙀", Y6 = "😿", X6 = "😾", K6 = "🙈", e4 = "🙉", n4 = "🙊", t4 = "💋", o4 = "💌", s4 = "💘", r4 = "💝", c4 = "💖", a4 = "💗", i4 = "💓", l4 = "💞", u4 = "💕", p4 = "💟", h4 = "❣️", d4 = "💔", f4 = "❤️", m4 = "🧡", g4 = "💛", _4 = "💚", b4 = "💙", k4 = "💜", w4 = "🤎", y4 = "🖤", v4 = "🤍", x4 = "💢", A4 = "💥", S4 = "💥", L4 = "💫", C4 = "💦", E4 = "💨", T4 = "🕳️", D4 = "💣", q4 = "💬", j4 = "👁️‍🗨️", R4 = "🗨️", N4 = "🗯️", P4 = "💭", I4 = "💤", O4 = "👋", F4 = "🤚", M4 = "🖐️", B4 = "✋", $4 = "✋", z4 = "🖖", G4 = "👌", U4 = "🤌", H4 = "🤏", V4 = "✌️", W4 = "🤞", Z4 = "🤟", J4 = "🤘", Q4 = "🤙", Y4 = "👈", X4 = "👉", K4 = "👆", e8 = "🖕", n8 = "🖕", t8 = "👇", o8 = "☝️", s8 = "👍", r8 = "👎", c8 = "✊", a8 = "✊", i8 = "👊", l8 = "👊", u8 = "👊", p8 = "🤛", h8 = "🤜", d8 = "👏", f8 = "🙌", m8 = "👐", g8 = "🤲", _8 = "🤝", b8 = "🙏", k8 = "✍️", w8 = "💅", y8 = "🤳", v8 = "💪", x8 = "🦾", A8 = "🦿", S8 = "🦵", L8 = "🦶", C8 = "👂", E8 = "🦻", T8 = "👃", D8 = "🧠", q8 = "🫀", j8 = "🫁", R8 = "🦷", N8 = "🦴", P8 = "👀", I8 = "👁️", O8 = "👅", F8 = "👄", M8 = "👶", B8 = "🧒", $8 = "👦", z8 = "👧", G8 = "🧑", U8 = "👱", H8 = "👨", V8 = "🧔", W8 = "👨‍🦰", Z8 = "👨‍🦱", J8 = "👨‍🦳", Q8 = "👨‍🦲", Y8 = "👩", X8 = "👩‍🦰", K8 = "🧑‍🦰", eG = "👩‍🦱", nG = "🧑‍🦱", tG = "👩‍🦳", oG = "🧑‍🦳", sG = "👩‍🦲", rG = "🧑‍🦲", cG = "👱‍♀️", aG = "👱‍♀️", iG = "👱‍♂️", lG = "🧓", uG = "👴", pG = "👵", hG = "🙍", dG = "🙍‍♂️", fG = "🙍‍♀️", mG = "🙎", gG = "🙎‍♂️", _G = "🙎‍♀️", bG = "🙅", kG = "🙅‍♂️", wG = "🙅‍♂️", yG = "🙅‍♀️", vG = "🙅‍♀️", xG = "🙆", AG = "🙆‍♂️", SG = "🙆‍♀️", LG = "💁", CG = "💁", EG = "💁‍♂️", TG = "💁‍♂️", DG = "💁‍♀️", qG = "💁‍♀️", jG = "🙋", RG = "🙋‍♂️", NG = "🙋‍♀️", PG = "🧏", IG = "🧏‍♂️", OG = "🧏‍♀️", FG = "🙇", MG = "🙇‍♂️", BG = "🙇‍♀️", $G = "🤦", zG = "🤦‍♂️", GG = "🤦‍♀️", UG = "🤷", HG = "🤷‍♂️", VG = "🤷‍♀️", WG = "🧑‍⚕️", ZG = "👨‍⚕️", JG = "👩‍⚕️", QG = "🧑‍🎓", YG = "👨‍🎓", XG = "👩‍🎓", KG = "🧑‍🏫", eU = "👨‍🏫", nU = "👩‍🏫", tU = "🧑‍⚖️", oU = "👨‍⚖️", sU = "👩‍⚖️", rU = "🧑‍🌾", cU = "👨‍🌾", aU = "👩‍🌾", iU = "🧑‍🍳", lU = "👨‍🍳", uU = "👩‍🍳", pU = "🧑‍🔧", hU = "👨‍🔧", dU = "👩‍🔧", fU = "🧑‍🏭", mU = "👨‍🏭", gU = "👩‍🏭", _U = "🧑‍💼", bU = "👨‍💼", kU = "👩‍💼", wU = "🧑‍🔬", yU = "👨‍🔬", vU = "👩‍🔬", xU = "🧑‍💻", AU = "👨‍💻", SU = "👩‍💻", LU = "🧑‍🎤", CU = "👨‍🎤", EU = "👩‍🎤", TU = "🧑‍🎨", DU = "👨‍🎨", qU = "👩‍🎨", jU = "🧑‍✈️", RU = "👨‍✈️", NU = "👩‍✈️", PU = "🧑‍🚀", IU = "👨‍🚀", OU = "👩‍🚀", FU = "🧑‍🚒", MU = "👨‍🚒", BU = "👩‍🚒", $U = "👮", zU = "👮", GU = "👮‍♂️", UU = "👮‍♀️", HU = "🕵️", VU = "🕵️‍♂️", WU = "🕵️‍♀️", ZU = "💂", JU = "💂‍♂️", QU = "💂‍♀️", YU = "🥷", XU = "👷", KU = "👷‍♂️", e9 = "👷‍♀️", n9 = "🤴", t9 = "👸", o9 = "👳", s9 = "👳‍♂️", r9 = "👳‍♀️", c9 = "👲", a9 = "🧕", i9 = "🤵", l9 = "🤵‍♂️", u9 = "🤵‍♀️", p9 = "👰", h9 = "👰‍♂️", d9 = "👰‍♀️", f9 = "👰‍♀️", m9 = "🤰", g9 = "🤱", _9 = "👩‍🍼", b9 = "👨‍🍼", k9 = "🧑‍🍼", w9 = "👼", y9 = "🎅", v9 = "🤶", x9 = "🧑‍🎄", A9 = "🦸", S9 = "🦸‍♂️", L9 = "🦸‍♀️", C9 = "🦹", E9 = "🦹‍♂️", T9 = "🦹‍♀️", D9 = "🧙", q9 = "🧙‍♂️", j9 = "🧙‍♀️", R9 = "🧚", N9 = "🧚‍♂️", P9 = "🧚‍♀️", I9 = "🧛", O9 = "🧛‍♂️", F9 = "🧛‍♀️", M9 = "🧜", B9 = "🧜‍♂️", $9 = "🧜‍♀️", z9 = "🧝", G9 = "🧝‍♂️", U9 = "🧝‍♀️", H9 = "🧞", V9 = "🧞‍♂️", W9 = "🧞‍♀️", Z9 = "🧟", J9 = "🧟‍♂️", Q9 = "🧟‍♀️", Y9 = "💆", X9 = "💆‍♂️", K9 = "💆‍♀️", e7 = "💇", n7 = "💇‍♂️", t7 = "💇‍♀️", o7 = "🚶", s7 = "🚶‍♂️", r7 = "🚶‍♀️", c7 = "🧍", a7 = "🧍‍♂️", i7 = "🧍‍♀️", l7 = "🧎", u7 = "🧎‍♂️", p7 = "🧎‍♀️", h7 = "🧑‍🦯", d7 = "👨‍🦯", f7 = "👩‍🦯", m7 = "🧑‍🦼", g7 = "👨‍🦼", _7 = "👩‍🦼", b7 = "🧑‍🦽", k7 = "👨‍🦽", w7 = "👩‍🦽", y7 = "🏃", v7 = "🏃", x7 = "🏃‍♂️", A7 = "🏃‍♀️", S7 = "💃", L7 = "💃", C7 = "🕺", E7 = "🕴️", T7 = "👯", D7 = "👯‍♂️", q7 = "👯‍♀️", j7 = "🧖", R7 = "🧖‍♂️", N7 = "🧖‍♀️", P7 = "🧗", I7 = "🧗‍♂️", O7 = "🧗‍♀️", F7 = "🤺", M7 = "🏇", B7 = "⛷️", $7 = "🏂", z7 = "🏌️", G7 = "🏌️‍♂️", U7 = "🏌️‍♀️", H7 = "🏄", V7 = "🏄‍♂️", W7 = "🏄‍♀️", Z7 = "🚣", J7 = "🚣‍♂️", Q7 = "🚣‍♀️", Y7 = "🏊", X7 = "🏊‍♂️", K7 = "🏊‍♀️", eH = "⛹️", nH = "⛹️‍♂️", tH = "⛹️‍♂️", oH = "⛹️‍♀️", sH = "⛹️‍♀️", rH = "🏋️", cH = "🏋️‍♂️", aH = "🏋️‍♀️", iH = "🚴", lH = "🚴‍♂️", uH = "🚴‍♀️", pH = "🚵", hH = "🚵‍♂️", dH = "🚵‍♀️", fH = "🤸", mH = "🤸‍♂️", gH = "🤸‍♀️", _H = "🤼", bH = "🤼‍♂️", kH = "🤼‍♀️", wH = "🤽", yH = "🤽‍♂️", vH = "🤽‍♀️", xH = "🤾", AH = "🤾‍♂️", SH = "🤾‍♀️", LH = "🤹", CH = "🤹‍♂️", EH = "🤹‍♀️", TH = "🧘", DH = "🧘‍♂️", qH = "🧘‍♀️", jH = "🛀", RH = "🛌", NH = "🧑‍🤝‍🧑", PH = "👭", IH = "👫", OH = "👬", FH = "💏", MH = "👩‍❤️‍💋‍👨", BH = "👨‍❤️‍💋‍👨", $H = "👩‍❤️‍💋‍👩", zH = "💑", GH = "👩‍❤️‍👨", UH = "👨‍❤️‍👨", HH = "👩‍❤️‍👩", VH = "👪", WH = "👨‍👩‍👦", ZH = "👨‍👩‍👧", JH = "👨‍👩‍👧‍👦", QH = "👨‍👩‍👦‍👦", YH = "👨‍👩‍👧‍👧", XH = "👨‍👨‍👦", KH = "👨‍👨‍👧", eV = "👨‍👨‍👧‍👦", nV = "👨‍👨‍👦‍👦", tV = "👨‍👨‍👧‍👧", oV = "👩‍👩‍👦", sV = "👩‍👩‍👧", rV = "👩‍👩‍👧‍👦", cV = "👩‍👩‍👦‍👦", aV = "👩‍👩‍👧‍👧", iV = "👨‍👦", lV = "👨‍👦‍👦", uV = "👨‍👧", pV = "👨‍👧‍👦", hV = "👨‍👧‍👧", dV = "👩‍👦", fV = "👩‍👦‍👦", mV = "👩‍👧", gV = "👩‍👧‍👦", _V = "👩‍👧‍👧", bV = "🗣️", kV = "👤", wV = "👥", yV = "🫂", vV = "👣", xV = "🐵", AV = "🐒", SV = "🦍", LV = "🦧", CV = "🐶", EV = "🐕", TV = "🦮", DV = "🐕‍🦺", qV = "🐩", jV = "🐺", RV = "🦊", NV = "🦝", PV = "🐱", IV = "🐈", OV = "🐈‍⬛", FV = "🦁", MV = "🐯", BV = "🐅", $V = "🐆", zV = "🐴", GV = "🐎", UV = "🦄", HV = "🦓", VV = "🦌", WV = "🦬", ZV = "🐮", JV = "🐂", QV = "🐃", YV = "🐄", XV = "🐷", KV = "🐖", eW = "🐗", nW = "🐽", tW = "🐏", oW = "🐑", sW = "🐐", rW = "🐪", cW = "🐫", aW = "🦙", iW = "🦒", lW = "🐘", uW = "🦣", pW = "🦏", hW = "🦛", dW = "🐭", fW = "🐁", mW = "🐀", gW = "🐹", _W = "🐰", bW = "🐇", kW = "🐿️", wW = "🦫", yW = "🦔", vW = "🦇", xW = "🐻", AW = "🐻‍❄️", SW = "🐨", LW = "🐼", CW = "🦥", EW = "🦦", TW = "🦨", DW = "🦘", qW = "🦡", jW = "🐾", RW = "🐾", NW = "🦃", PW = "🐔", IW = "🐓", OW = "🐣", FW = "🐤", MW = "🐥", BW = "🐦", $W = "🐧", zW = "🕊️", GW = "🦅", UW = "🦆", HW = "🦢", VW = "🦉", WW = "🦤", ZW = "🪶", JW = "🦩", QW = "🦚", YW = "🦜", XW = "🐸", KW = "🐊", eZ = "🐢", nZ = "🦎", tZ = "🐍", oZ = "🐲", sZ = "🐉", rZ = "🦕", cZ = "🐳", aZ = "🐋", iZ = "🐬", lZ = "🐬", uZ = "🦭", pZ = "🐟", hZ = "🐠", dZ = "🐡", fZ = "🦈", mZ = "🐙", gZ = "🐚", _Z = "🐌", bZ = "🦋", kZ = "🐛", wZ = "🐜", yZ = "🐝", vZ = "🐝", xZ = "🪲", AZ = "🐞", SZ = "🦗", LZ = "🪳", CZ = "🕷️", EZ = "🕸️", TZ = "🦂", DZ = "🦟", qZ = "🪰", jZ = "🪱", RZ = "🦠", NZ = "💐", PZ = "🌸", IZ = "💮", OZ = "🏵️", FZ = "🌹", MZ = "🥀", BZ = "🌺", $Z = "🌻", zZ = "🌼", GZ = "🌷", UZ = "🌱", HZ = "🪴", VZ = "🌲", WZ = "🌳", ZZ = "🌴", JZ = "🌵", QZ = "🌾", YZ = "🌿", XZ = "☘️", KZ = "🍀", eJ = "🍁", nJ = "🍂", tJ = "🍃", oJ = "🍇", sJ = "🍈", rJ = "🍉", cJ = "🍊", aJ = "🍊", iJ = "🍊", lJ = "🍋", uJ = "🍌", pJ = "🍍", hJ = "🥭", dJ = "🍎", fJ = "🍏", mJ = "🍐", gJ = "🍑", _J = "🍒", bJ = "🍓", kJ = "🫐", wJ = "🥝", yJ = "🍅", vJ = "🫒", xJ = "🥥", AJ = "🥑", SJ = "🍆", LJ = "🥔", CJ = "🥕", EJ = "🌽", TJ = "🌶️", DJ = "🫑", qJ = "🥒", jJ = "🥬", RJ = "🥦", NJ = "🧄", PJ = "🧅", IJ = "🍄", OJ = "🥜", FJ = "🌰", MJ = "🍞", BJ = "🥐", $J = "🥖", zJ = "🫓", GJ = "🥨", UJ = "🥯", HJ = "🥞", VJ = "🧇", WJ = "🧀", ZJ = "🍖", JJ = "🍗", QJ = "🥩", YJ = "🥓", XJ = "🍔", KJ = "🍟", eQ = "🍕", nQ = "🌭", tQ = "🥪", oQ = "🌮", sQ = "🌯", rQ = "🫔", cQ = "🥙", aQ = "🧆", iQ = "🥚", lQ = "🍳", uQ = "🥘", pQ = "🍲", hQ = "🫕", dQ = "🥣", fQ = "🥗", mQ = "🍿", gQ = "🧈", _Q = "🧂", bQ = "🥫", kQ = "🍱", wQ = "🍘", yQ = "🍙", vQ = "🍚", xQ = "🍛", AQ = "🍜", SQ = "🍝", LQ = "🍠", CQ = "🍢", EQ = "🍣", TQ = "🍤", DQ = "🍥", qQ = "🥮", jQ = "🍡", RQ = "🥟", NQ = "🥠", PQ = "🥡", IQ = "🦀", OQ = "🦞", FQ = "🦐", MQ = "🦑", BQ = "🦪", $Q = "🍦", zQ = "🍧", GQ = "🍨", UQ = "🍩", HQ = "🍪", VQ = "🎂", WQ = "🍰", ZQ = "🧁", JQ = "🥧", QQ = "🍫", YQ = "🍬", XQ = "🍭", KQ = "🍮", eY = "🍯", nY = "🍼", tY = "🥛", oY = "☕", sY = "🫖", rY = "🍵", cY = "🍶", aY = "🍾", iY = "🍷", lY = "🍸", uY = "🍹", pY = "🍺", hY = "🍻", dY = "🥂", fY = "🥃", mY = "🥤", gY = "🧋", _Y = "🧃", bY = "🧉", kY = "🧊", wY = "🥢", yY = "🍽️", vY = "🍴", xY = "🥄", AY = "🔪", SY = "🔪", LY = "🏺", CY = "🌍", EY = "🌎", TY = "🌏", DY = "🌐", qY = "🗺️", jY = "🗾", RY = "🧭", NY = "🏔️", PY = "⛰️", IY = "🌋", OY = "🗻", FY = "🏕️", MY = "🏖️", BY = "🏜️", $Y = "🏝️", zY = "🏞️", GY = "🏟️", UY = "🏛️", HY = "🏗️", VY = "🧱", WY = "🪨", ZY = "🪵", JY = "🛖", QY = "🏘️", YY = "🏚️", XY = "🏠", KY = "🏡", eX = "🏢", nX = "🏣", tX = "🏤", oX = "🏥", sX = "🏦", rX = "🏨", cX = "🏩", aX = "🏪", iX = "🏫", lX = "🏬", uX = "🏭", pX = "🏯", hX = "🏰", dX = "💒", fX = "🗼", mX = "🗽", gX = "⛪", _X = "🕌", bX = "🛕", kX = "🕍", wX = "⛩️", yX = "🕋", vX = "⛲", xX = "⛺", AX = "🌁", SX = "🌃", LX = "🏙️", CX = "🌄", EX = "🌅", TX = "🌆", DX = "🌇", qX = "🌉", jX = "♨️", RX = "🎠", NX = "🎡", PX = "🎢", IX = "💈", OX = "🎪", FX = "🚂", MX = "🚃", BX = "🚄", $X = "🚅", zX = "🚆", GX = "🚇", UX = "🚈", HX = "🚉", VX = "🚊", WX = "🚝", ZX = "🚞", JX = "🚋", QX = "🚌", YX = "🚍", XX = "🚎", KX = "🚐", eK = "🚑", nK = "🚒", tK = "🚓", oK = "🚔", sK = "🚕", rK = "🚖", cK = "🚗", aK = "🚗", iK = "🚘", lK = "🚙", uK = "🛻", pK = "🚚", hK = "🚛", dK = "🚜", fK = "🏎️", mK = "🏍️", gK = "🛵", _K = "🦽", bK = "🦼", kK = "🛺", wK = "🚲", yK = "🛴", vK = "🛹", xK = "🛼", AK = "🚏", SK = "🛣️", LK = "🛤️", CK = "🛢️", EK = "⛽", TK = "🚨", DK = "🚥", qK = "🚦", jK = "🛑", RK = "🚧", NK = "⚓", PK = "⛵", IK = "⛵", OK = "🛶", FK = "🚤", MK = "🛳️", BK = "⛴️", $K = "🛥️", zK = "🚢", GK = "✈️", UK = "🛩️", HK = "🛫", VK = "🛬", WK = "🪂", ZK = "💺", JK = "🚁", QK = "🚟", YK = "🚠", XK = "🚡", KK = "🛰️", eee = "🚀", nee = "🛸", tee = "🛎️", oee = "🧳", see = "⌛", ree = "⏳", cee = "⌚", aee = "⏰", iee = "⏱️", lee = "⏲️", uee = "🕰️", pee = "🕛", hee = "🕧", dee = "🕐", fee = "🕜", mee = "🕑", gee = "🕝", _ee = "🕒", bee = "🕞", kee = "🕓", wee = "🕟", yee = "🕔", vee = "🕠", xee = "🕕", Aee = "🕡", See = "🕖", Lee = "🕢", Cee = "🕗", Eee = "🕣", Tee = "🕘", Dee = "🕤", qee = "🕙", jee = "🕥", Ree = "🕚", Nee = "🕦", Pee = "🌑", Iee = "🌒", Oee = "🌓", Fee = "🌔", Mee = "🌔", Bee = "🌕", $ee = "🌖", zee = "🌗", Gee = "🌘", Uee = "🌙", Hee = "🌚", Vee = "🌛", Wee = "🌜", Zee = "🌡️", Jee = "☀️", Qee = "🌝", Yee = "🌞", Xee = "🪐", Kee = "⭐", ene = "🌟", nne = "🌠", tne = "🌌", one = "☁️", sne = "⛅", rne = "⛈️", cne = "🌤️", ane = "🌥️", ine = "🌦️", lne = "🌧️", une = "🌨️", pne = "🌩️", hne = "🌪️", dne = "🌫️", fne = "🌬️", mne = "🌀", gne = "🌈", _ne = "🌂", bne = "☂️", kne = "☔", wne = "⛱️", yne = "⚡", vne = "❄️", xne = "☃️", Ane = "⛄", Sne = "☄️", Lne = "🔥", Cne = "💧", Ene = "🌊", Tne = "🎃", Dne = "🎄", qne = "🎆", jne = "🎇", Rne = "🧨", Nne = "✨", Pne = "🎈", Ine = "🎉", One = "🎊", Fne = "🎋", Mne = "🎍", Bne = "🎎", $ne = "🎏", zne = "🎐", Gne = "🎑", Une = "🧧", Hne = "🎀", Vne = "🎁", Wne = "🎗️", Zne = "🎟️", Jne = "🎫", Qne = "🎖️", Yne = "🏆", Xne = "🏅", Kne = "⚽", ete = "⚾", nte = "🥎", tte = "🏀", ote = "🏐", ste = "🏈", rte = "🏉", cte = "🎾", ate = "🥏", ite = "🎳", lte = "🏏", ute = "🏑", pte = "🏒", hte = "🥍", dte = "🏓", fte = "🏸", mte = "🥊", gte = "🥋", _te = "🥅", bte = "⛳", kte = "⛸️", wte = "🎣", yte = "🤿", vte = "🎽", xte = "🎿", Ate = "🛷", Ste = "🥌", Lte = "🎯", Cte = "🪀", Ete = "🪁", Tte = "🔮", Dte = "🪄", qte = "🧿", jte = "🎮", Rte = "🕹️", Nte = "🎰", Pte = "🎲", Ite = "🧩", Ote = "🧸", Fte = "🪅", Mte = "🪆", Bte = "♠️", $te = "♥️", zte = "♦️", Gte = "♣️", Ute = "♟️", Hte = "🃏", Vte = "🀄", Wte = "🎴", Zte = "🎭", Jte = "🖼️", Qte = "🎨", Yte = "🧵", Xte = "🪡", Kte = "🧶", eoe = "🪢", noe = "👓", toe = "🕶️", ooe = "🥽", soe = "🥼", roe = "🦺", coe = "👔", aoe = "👕", ioe = "👕", loe = "👖", uoe = "🧣", poe = "🧤", hoe = "🧥", doe = "🧦", foe = "👗", moe = "👘", goe = "🥻", _oe = "🩱", boe = "🩲", koe = "🩳", woe = "👙", yoe = "👚", voe = "👛", xoe = "👜", Aoe = "👝", Soe = "🛍️", Loe = "🎒", Coe = "🩴", Eoe = "👞", Toe = "👞", Doe = "👟", qoe = "🥾", joe = "🥿", Roe = "👠", Noe = "👡", Poe = "🩰", Ioe = "👢", Ooe = "👑", Foe = "👒", Moe = "🎩", Boe = "🎓", $oe = "🧢", zoe = "🪖", Goe = "⛑️", Uoe = "📿", Hoe = "💄", Voe = "💍", Woe = "💎", Zoe = "🔇", Joe = "🔈", Qoe = "🔉", Yoe = "🔊", Xoe = "📢", Koe = "📣", ese = "📯", nse = "🔔", tse = "🔕", ose = "🎼", sse = "🎵", rse = "🎶", cse = "🎙️", ase = "🎚️", ise = "🎛️", lse = "🎤", use = "🎧", pse = "📻", hse = "🎷", dse = "🪗", fse = "🎸", mse = "🎹", gse = "🎺", _se = "🎻", bse = "🪕", kse = "🥁", wse = "🪘", yse = "📱", vse = "📲", xse = "☎️", Ase = "☎️", Sse = "📞", Lse = "📟", Cse = "📠", Ese = "🔋", Tse = "🔌", Dse = "💻", qse = "🖥️", jse = "🖨️", Rse = "⌨️", Nse = "🖱️", Pse = "🖲️", Ise = "💽", Ose = "💾", Fse = "💿", Mse = "📀", Bse = "🧮", $se = "🎥", zse = "🎞️", Gse = "📽️", Use = "🎬", Hse = "📺", Vse = "📷", Wse = "📸", Zse = "📹", Jse = "📼", Qse = "🔍", Yse = "🔎", Xse = "🕯️", Kse = "💡", ere = "🔦", nre = "🏮", tre = "🏮", ore = "🪔", sre = "📔", rre = "📕", cre = "📖", are = "📖", ire = "📗", lre = "📘", ure = "📙", pre = "📚", hre = "📓", dre = "📒", fre = "📃", mre = "📜", gre = "📄", _re = "📰", bre = "🗞️", kre = "📑", wre = "🔖", yre = "🏷️", vre = "💰", xre = "🪙", Are = "💴", Sre = "💵", Lre = "💶", Cre = "💷", Ere = "💸", Tre = "💳", Dre = "🧾", qre = "💹", jre = "✉️", Rre = "📧", Nre = "📨", Pre = "📩", Ire = "📤", Ore = "📥", Fre = "📫", Mre = "📪", Bre = "📬", $re = "📭", zre = "📮", Gre = "🗳️", Ure = "✏️", Hre = "✒️", Vre = "🖋️", Wre = "🖊️", Zre = "🖌️", Jre = "🖍️", Qre = "📝", Yre = "📝", Xre = "💼", Kre = "📁", ece = "📂", nce = "🗂️", tce = "📅", oce = "📆", sce = "🗒️", rce = "🗓️", cce = "📇", ace = "📈", ice = "📉", lce = "📊", uce = "📋", pce = "📌", hce = "📍", dce = "📎", fce = "🖇️", mce = "📏", gce = "📐", _ce = "✂️", bce = "🗃️", kce = "🗄️", wce = "🗑️", yce = "🔒", vce = "🔓", xce = "🔏", Ace = "🔐", Sce = "🔑", Lce = "🗝️", Cce = "🔨", Ece = "🪓", Tce = "⛏️", Dce = "⚒️", qce = "🛠️", jce = "🗡️", Rce = "⚔️", Nce = "🔫", Pce = "🪃", Ice = "🏹", Oce = "🛡️", Fce = "🪚", Mce = "🔧", Bce = "🪛", $ce = "🔩", zce = "⚙️", Gce = "🗜️", Uce = "⚖️", Hce = "🦯", Vce = "🔗", Wce = "⛓️", Zce = "🪝", Jce = "🧰", Qce = "🧲", Yce = "🪜", Xce = "⚗️", Kce = "🧪", eae = "🧫", nae = "🧬", tae = "🔬", oae = "🔭", sae = "📡", rae = "💉", cae = "🩸", aae = "💊", iae = "🩹", lae = "🩺", uae = "🚪", pae = "🛗", hae = "🪞", dae = "🪟", fae = "🛏️", mae = "🛋️", gae = "🪑", _ae = "🚽", bae = "🪠", kae = "🚿", wae = "🛁", yae = "🪤", vae = "🪒", xae = "🧴", Aae = "🧷", Sae = "🧹", Lae = "🧺", Cae = "🧻", Eae = "🪣", Tae = "🧼", Dae = "🪥", qae = "🧽", jae = "🧯", Rae = "🛒", Nae = "🚬", Pae = "⚰️", Iae = "🪦", Oae = "⚱️", Fae = "🗿", Mae = "🪧", Bae = "🏧", $ae = "🚮", zae = "🚰", Gae = "♿", Uae = "🚹", Hae = "🚺", Vae = "🚻", Wae = "🚼", Zae = "🚾", Jae = "🛂", Qae = "🛃", Yae = "🛄", Xae = "🛅", Kae = "⚠️", eie = "🚸", nie = "⛔", tie = "🚫", oie = "🚳", sie = "🚭", rie = "🚯", cie = "🚷", aie = "📵", iie = "🔞", lie = "☢️", uie = "☣️", pie = "⬆️", hie = "↗️", die = "➡️", fie = "↘️", mie = "⬇️", gie = "↙️", _ie = "⬅️", bie = "↖️", kie = "↕️", wie = "↔️", yie = "↩️", vie = "↪️", xie = "⤴️", Aie = "⤵️", Sie = "🔃", Lie = "🔄", Cie = "🔙", Eie = "🔚", Tie = "🔛", Die = "🔜", qie = "🔝", jie = "🛐", Rie = "⚛️", Nie = "🕉️", Pie = "✡️", Iie = "☸️", Oie = "☯️", Fie = "✝️", Mie = "☦️", Bie = "☪️", $ie = "☮️", zie = "🕎", Gie = "🔯", Uie = "♈", Hie = "♉", Vie = "♊", Wie = "♋", Zie = "♌", Jie = "♍", Qie = "♎", Yie = "♏", Xie = "♐", Kie = "♑", ele = "♒", nle = "♓", tle = "⛎", ole = "🔀", sle = "🔁", rle = "🔂", cle = "▶️", ale = "⏩", ile = "⏭️", lle = "⏯️", ule = "◀️", ple = "⏪", hle = "⏮️", dle = "🔼", fle = "⏫", mle = "🔽", gle = "⏬", _le = "⏸️", ble = "⏹️", kle = "⏺️", wle = "⏏️", yle = "🎦", vle = "🔅", xle = "🔆", Ale = "📶", Sle = "📳", Lle = "📴", Cle = "♀️", Ele = "♂️", Tle = "⚧️", Dle = "✖️", qle = "➕", jle = "➖", Rle = "➗", Nle = "♾️", Ple = "‼️", Ile = "⁉️", Ole = "❓", Fle = "❔", Mle = "❕", Ble = "❗", $le = "❗", zle = "〰️", Gle = "💱", Ule = "💲", Hle = "⚕️", Vle = "♻️", Wle = "⚜️", Zle = "🔱", Jle = "📛", Qle = "🔰", Yle = "⭕", Xle = "✅", Kle = "☑️", eue = "✔️", nue = "❌", tue = "❎", oue = "➰", sue = "➿", rue = "〽️", cue = "✳️", aue = "✴️", iue = "❇️", lue = "©️", uue = "®️", pue = "™️", hue = "#️⃣", due = "*️⃣", fue = "0️⃣", mue = "1️⃣", gue = "2️⃣", _ue = "3️⃣", bue = "4️⃣", kue = "5️⃣", wue = "6️⃣", yue = "7️⃣", vue = "8️⃣", xue = "9️⃣", Aue = "🔟", Sue = "🔠", Lue = "🔡", Cue = "🔣", Eue = "🔤", Tue = "🅰️", Due = "🆎", que = "🅱️", jue = "🆑", Rue = "🆒", Nue = "🆓", Pue = "ℹ️", Iue = "🆔", Oue = "Ⓜ️", Fue = "🆖", Mue = "🅾️", Bue = "🆗", $ue = "🅿️", zue = "🆘", Gue = "🆙", Uue = "🆚", Hue = "🈁", Vue = "🈂️", Wue = "🉐", Zue = "🉑", Jue = "㊗️", Que = "㊙️", Yue = "🈵", Xue = "🔴", Kue = "🟠", epe = "🟡", npe = "🟢", tpe = "🔵", ope = "🟣", spe = "🟤", rpe = "⚫", cpe = "⚪", ape = "🟥", ipe = "🟧", lpe = "🟨", upe = "🟩", ppe = "🟦", hpe = "🟪", dpe = "🟫", fpe = "⬛", mpe = "⬜", gpe = "◼️", _pe = "◻️", bpe = "◾", kpe = "◽", wpe = "▪️", ype = "▫️", vpe = "🔶", xpe = "🔷", Ape = "🔸", Spe = "🔹", Lpe = "🔺", Cpe = "🔻", Epe = "💠", Tpe = "🔘", Dpe = "🔳", qpe = "🔲", jpe = "🏁", Rpe = "🚩", Npe = "🎌", Ppe = "🏴", Ipe = "🏳️", Ope = "🏳️‍🌈", Fpe = "🏳️‍⚧️", Mpe = "🏴‍☠️", Bpe = "🇦🇨", $pe = "🇦🇩", zpe = "🇦🇪", Gpe = "🇦🇫", Upe = "🇦🇬", Hpe = "🇦🇮", Vpe = "🇦🇱", Wpe = "🇦🇲", Zpe = "🇦🇴", Jpe = "🇦🇶", Qpe = "🇦🇷", Ype = "🇦🇸", Xpe = "🇦🇹", Kpe = "🇦🇺", ehe = "🇦🇼", nhe = "🇦🇽", the = "🇦🇿", ohe = "🇧🇦", she = "🇧🇧", rhe = "🇧🇩", che = "🇧🇪", ahe = "🇧🇫", ihe = "🇧🇬", lhe = "🇧🇭", uhe = "🇧🇮", phe = "🇧🇯", hhe = "🇧🇱", dhe = "🇧🇲", fhe = "🇧🇳", mhe = "🇧🇴", ghe = "🇧🇶", _he = "🇧🇷", bhe = "🇧🇸", khe = "🇧🇹", whe = "🇧🇻", yhe = "🇧🇼", vhe = "🇧🇾", xhe = "🇧🇿", Ahe = "🇨🇦", She = "🇨🇨", Lhe = "🇨🇩", Che = "🇨🇫", Ehe = "🇨🇬", The = "🇨🇭", Dhe = "🇨🇮", qhe = "🇨🇰", jhe = "🇨🇱", Rhe = "🇨🇲", Nhe = "🇨🇳", Phe = "🇨🇴", Ihe = "🇨🇵", Ohe = "🇨🇷", Fhe = "🇨🇺", Mhe = "🇨🇻", Bhe = "🇨🇼", $he = "🇨🇽", zhe = "🇨🇾", Ghe = "🇨🇿", Uhe = "🇩🇪", Hhe = "🇩🇬", Vhe = "🇩🇯", Whe = "🇩🇰", Zhe = "🇩🇲", Jhe = "🇩🇴", Qhe = "🇩🇿", Yhe = "🇪🇦", Xhe = "🇪🇨", Khe = "🇪🇪", ede = "🇪🇬", nde = "🇪🇭", tde = "🇪🇷", ode = "🇪🇸", sde = "🇪🇹", rde = "🇪🇺", cde = "🇪🇺", ade = "🇫🇮", ide = "🇫🇯", lde = "🇫🇰", ude = "🇫🇲", pde = "🇫🇴", hde = "🇫🇷", dde = "🇬🇦", fde = "🇬🇧", mde = "🇬🇧", gde = "🇬🇩", _de = "🇬🇪", bde = "🇬🇫", kde = "🇬🇬", wde = "🇬🇭", yde = "🇬🇮", vde = "🇬🇱", xde = "🇬🇲", Ade = "🇬🇳", Sde = "🇬🇵", Lde = "🇬🇶", Cde = "🇬🇷", Ede = "🇬🇸", Tde = "🇬🇹", Dde = "🇬🇺", qde = "🇬🇼", jde = "🇬🇾", Rde = "🇭🇰", Nde = "🇭🇲", Pde = "🇭🇳", Ide = "🇭🇷", Ode = "🇭🇹", Fde = "🇭🇺", Mde = "🇮🇨", Bde = "🇮🇩", $de = "🇮🇪", zde = "🇮🇱", Gde = "🇮🇲", Ude = "🇮🇳", Hde = "🇮🇴", Vde = "🇮🇶", Wde = "🇮🇷", Zde = "🇮🇸", Jde = "🇮🇹", Qde = "🇯🇪", Yde = "🇯🇲", Xde = "🇯🇴", Kde = "🇯🇵", efe = "🇰🇪", nfe = "🇰🇬", tfe = "🇰🇭", ofe = "🇰🇮", sfe = "🇰🇲", rfe = "🇰🇳", cfe = "🇰🇵", afe = "🇰🇷", ife = "🇰🇼", lfe = "🇰🇾", ufe = "🇰🇿", pfe = "🇱🇦", hfe = "🇱🇧", dfe = "🇱🇨", ffe = "🇱🇮", mfe = "🇱🇰", gfe = "🇱🇷", _fe = "🇱🇸", bfe = "🇱🇹", kfe = "🇱🇺", wfe = "🇱🇻", yfe = "🇱🇾", vfe = "🇲🇦", xfe = "🇲🇨", Afe = "🇲🇩", Sfe = "🇲🇪", Lfe = "🇲🇫", Cfe = "🇲🇬", Efe = "🇲🇭", Tfe = "🇲🇰", Dfe = "🇲🇱", qfe = "🇲🇲", jfe = "🇲🇳", Rfe = "🇲🇴", Nfe = "🇲🇵", Pfe = "🇲🇶", Ife = "🇲🇷", Ofe = "🇲🇸", Ffe = "🇲🇹", Mfe = "🇲🇺", Bfe = "🇲🇻", $fe = "🇲🇼", zfe = "🇲🇽", Gfe = "🇲🇾", Ufe = "🇲🇿", Hfe = "🇳🇦", Vfe = "🇳🇨", Wfe = "🇳🇪", Zfe = "🇳🇫", Jfe = "🇳🇬", Qfe = "🇳🇮", Yfe = "🇳🇱", Xfe = "🇳🇴", Kfe = "🇳🇵", eme = "🇳🇷", nme = "🇳🇺", tme = "🇳🇿", ome = "🇴🇲", sme = "🇵🇦", rme = "🇵🇪", cme = "🇵🇫", ame = "🇵🇬", ime = "🇵🇭", lme = "🇵🇰", ume = "🇵🇱", pme = "🇵🇲", hme = "🇵🇳", dme = "🇵🇷", fme = "🇵🇸", mme = "🇵🇹", gme = "🇵🇼", _me = "🇵🇾", bme = "🇶🇦", kme = "🇷🇪", wme = "🇷🇴", yme = "🇷🇸", vme = "🇷🇺", xme = "🇷🇼", Ame = "🇸🇦", Sme = "🇸🇧", Lme = "🇸🇨", Cme = "🇸🇩", Eme = "🇸🇪", Tme = "🇸🇬", Dme = "🇸🇭", qme = "🇸🇮", jme = "🇸🇯", Rme = "🇸🇰", Nme = "🇸🇱", Pme = "🇸🇲", Ime = "🇸🇳", Ome = "🇸🇴", Fme = "🇸🇷", Mme = "🇸🇸", Bme = "🇸🇹", $me = "🇸🇻", zme = "🇸🇽", Gme = "🇸🇾", Ume = "🇸🇿", Hme = "🇹🇦", Vme = "🇹🇨", Wme = "🇹🇩", Zme = "🇹🇫", Jme = "🇹🇬", Qme = "🇹🇭", Yme = "🇹🇯", Xme = "🇹🇰", Kme = "🇹🇱", ege = "🇹🇲", nge = "🇹🇳", tge = "🇹🇴", oge = "🇹🇷", sge = "🇹🇹", rge = "🇹🇻", cge = "🇹🇼", age = "🇹🇿", ige = "🇺🇦", lge = "🇺🇬", uge = "🇺🇲", pge = "🇺🇳", hge = "🇺🇸", dge = "🇺🇾", fge = "🇺🇿", mge = "🇻🇦", gge = "🇻🇨", _ge = "🇻🇪", bge = "🇻🇬", kge = "🇻🇮", wge = "🇻🇳", yge = "🇻🇺", vge = "🇼🇫", xge = "🇼🇸", Age = "🇽🇰", Sge = "🇾🇪", Lge = "🇾🇹", Cge = "🇿🇦", Ege = "🇿🇲", Tge = "🇿🇼", Dge = "🏴󠁧󠁢󠁥󠁮󠁧󠁿", qge = "🏴󠁧󠁢󠁳󠁣󠁴󠁿", jge = "🏴󠁧󠁢󠁷󠁬󠁳󠁿", Rge = {
  100: "💯",
  1234: "🔢",
  grinning: Uz,
  smiley: Hz,
  ...
  function i(p, h, d) {
    ...
    return p.replace(s, function(S, b, k) {
      ...
      if (o.hasOwnProperty(S)) {
        if (y = o[S], b > 0 && !l.test(k[b - 1]) || b + S.length < k.length && !l.test(k[b + S.length]))
          return;
      } else
        y = S.slice(1, -1);
      b > m && (f = new d("text", "", 0), f.content = p.slice(m, b), L.push(f)), f = new d("emoji", "", 0), f.markup = y, f.content = t[y], L.push(f), m = b + S.length;
...
var Zge = function(e, t, o) {
  ...
  function d(f, m, L, S) {
    var b, k, y, C, w, u, g, x, _ = !1, v = f.bMarks[m] + f.tShift[m], A = f.eMarks[m];
    if (l !== f.src.charCodeAt(v))
      return !1;
    for (b = v + 1; b <= A && c[(b - v) % i] === f.src[b]; b++)
      ;
    if (y = Math.floor((b - v) / i), y < a || (b -= (b - v) % i, C = f.src.slice(v, b), w = f.src.slice(b, A), !p(w, C)))
      return !1;
    if (S)
      return !0;
    for (k = m; k++, !(k >= L || (v = f.bMarks[k] + f.tShift[k], A = f.eMarks[k], v < A && f.sCount[k] < f.blkIndent)); )
      if (l === f.src.charCodeAt(v) && !(f.sCount[k] - f.blkIndent >= 4)) {
        for (b = v + 1; b <= A && c[(b - v) % i] === f.src[b]; b++)
          ;
        if (!(Math.floor((b - v) / i) < y) && (b -= (b - v) % i, b = f.skipSpaces(b), !(b < A))) {
          _ = !0;
          break;
        }
      }
    return g = f.parentType, x = f.lineMax, f.parentType = "container", f.lineMax = k, u = f.push("container_" + t + "_open", "div", 1), u.markup = C, u.block = !0, u.info = w, u.map = [m, k], f.md.block.tokenize(f, m + 1, k), u = f.push("container_" + t + "_close", "div", -1), u.markup = f.src.slice(v, b), u.block = !0, f.parentType = g, f.lineMax = x, f.line = k + (_ ? 1 : 0), !0;
  }
  ...
  (function(t, o) {
    ...
    return t = { 770: function(r, s, a) {
      ...
      class h {
        static _utf8ByteLength(b) {
          ...
          for (let y = 0, C = b.length; y < C; y++) {
            const w = b.charCodeAt(y);
            let u = w, g = !1;
            if (w >= 55296 && w <= 56319 && y + 1 < C) {
              const x = b.charCodeAt(y + 1);
              x >= 56320 && x <= 57343 && (u = 65536 + (w - 55296 << 10) | x - 56320, g = !0);
            }
            k += u <= 127 ? 1 : u <= 2047 ? 2 : u <= 65535 ? 3 : 4, g && y++;
          }
          return k;
        }
        constructor(b) {
          const k = b.length, y = h._utf8ByteLength(b), C = y !== k, w = C ? new Uint32Array(k + 1) : null;
          C && (w[k] = y);
          const u = C ? new Uint32Array(y + 1) : null;
          C && (u[y] = k);
          const g = new Uint8Array(y);
          let x = 0;
          for (let _ = 0; _ < k; _++) {
            ...
            C && (w[_] = x, E && (w[_ + 1] = x), A <= 127 ? u[x + 0] = _ : A <= 2047 ? (u[x + 0] = _, u[x + 1] = _) : A <= 65535 ? (u[x + 0] = _, u[x + 1] = _, u[x + 2] = _) : (u[x + 0] = _, u[x + 1] = _, u[x + 2] = _, u[x + 3] = _)), A <= 127 ? g[x++] = A : A <= 2047 ? (g[x++] = 192 | (1984 & A) >>> 6, g[x++] = 128 | (63 & A) >>> 0) : A <= 65535 ? (g[x++] = 224 | (61440 & A) >>> 12, g[x++] = 128 | (4032 & A) >>> 6, g[x++] = 128 | (63 & A) >>> 0) : (g[x++] = 240 | (1835008 & A) >>> 18, g[x++] = 128 | (258048 & A) >>> 12, g[x++] = 128 | (4032 & A) >>> 6, g[x++] = 128 | (63 & A) >>> 0), E && _++;
          }
          this.utf16Length = k, this.utf8Length = y, this.utf16Value = b, this.utf8Value = g, this.utf16OffsetToUtf8 = w, this.utf8OffsetToUtf16 = u;
        }
        createString(b) {
      ...
      class f {
        constructor(b) {
          ...
          for (let g = 0, x = b.length; g < x; g++) {
            const _ = new h(b[g]);
            k[g] = _.createString(i), y[g] = _.utf8Length;
          }
          const C = i._omalloc(4 * b.length);
          i.HEAPU32.set(k, C / 4);
          const w = i._omalloc(4 * b.length);
          i.HEAPU32.set(y, w / 4);
          const u = i._createOnigScanner(C, w, b.length);
          for (let g = 0, x = b.length; g < x; g++)
            i._ofree(k[g]);
          i._ofree(w), i._ofree(C), u === 0 && function(g) {
        ...
        findNextMatchSync(b, k, y) {
          let C = p, w = 0;
          if (typeof y == "number" ? (8 & y && (C = !0), w = y) : typeof y == "boolean" && (C = y), typeof b == "string") {
            b = new d(b);
            const u = this._findNextMatchSync(b, k, C, w);
            return b.dispose(), u;
          }
          return this._findNextMatchSync(b, k, C, w);
        }
        _findNextMatchSync(b, k, y, C) {
          const w = this._onigBinding;
          let u;
          if (u = y ? w._findNextOnigScannerMatchDbg(this._ptr, b.id, b.ptr, b.utf8Length, b.convertUtf16OffsetToUtf8(k), C) : w._findNextOnigScannerMatch(this._ptr, b.id, b.ptr, b.utf8Length, b.convertUtf16OffsetToUtf8(k), C), u === 0)
            return null;
          const g = w.HEAPU32;
          let x = u / 4;
          const _ = g[x++], v = g[x++];
      ...
      s.loadWASM = function(S) {
        ...
        let b, k, y, C;
        if (m = !0, function(w) {
          return typeof w.instantiator == "function";
        }(S))
          ...
          })(S) ? (w = S.data, k = S.print) : w = S, b = function(u) {
            return typeof Response < "u" && u instanceof Response;
          }(w) ? typeof WebAssembly.instantiateStreaming == "function" ? function(u) {
        ...
        return L = new Promise((w, u) => {
          ...
          (0, l.default)({ print: u, instantiateWasm: (_, v) => {
            ...
            return w(_).then((A) => v(A.instance), x), {};
          } }).then((_) => {
            i = _, g();
          });
        }(b, k, y, C), L;
      ...
      var s = (typeof document < "u" && document.currentScript && document.currentScript.src, function(a) {
        ...
        var w, u, g, x = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0;
        function _(N, P, X) {
        ...
        function A(N) {
          w = N, i.HEAP8 = new Int8Array(N), i.HEAP16 = new Int16Array(N), i.HEAP32 = new Int32Array(N), i.HEAPU8 = u = new Uint8Array(N), i.HEAPU16 = new Uint16Array(N), i.HEAPU32 = g = new Uint32Array(N), i.HEAPF32 = new Float32Array(N), i.HEAPF64 = new Float64Array(N);
        }
        i.INITIAL_MEMORY;
        var E = [], D = [], T = [];
        function q() {
        ...
        function z(N) {
          i.onAbort && i.onAbort(N), k(N = "Aborted(" + N + ")"), y = !0, N += ". Build with -sASSERTIONS for more info.";
        ...
        function He() {
          var N = { env: Le, wasi_snapshot_preview1: Le };
          function P(W, H) {
            var K = W.exports;
        ...
        function je(N) {
          try {
            return S.grow(N - w.byteLength + 65535 >>> 16), A(S.buffer), 1;
          } catch {
          }
        }
        function xe(N) {
        ...
        function Re(N) {
          function P() {
            ee || (ee = !0, i.calledRun = !0, y || (R(), c(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), F()));
          }
    ...
    return (() => {
      var t = { 350: (r, s) => {
        ...
        Object.defineProperty(s, "__esModule", { value: !0 }), s.toOptionalTokenType = s.EncodedTokenAttributes = void 0, (a = s.EncodedTokenAttributes || (s.EncodedTokenAttributes = {})).toBinaryStr = function(c) {
          ...
          let m = a.getLanguageId(c), L = a.getTokenType(c), S = a.containsBalancedBrackets(c) ? 1 : 0, b = a.getFontStyle(c), k = a.getForeground(c), y = a.getBackground(c);
          return l !== 0 && (m = l), i !== 8 && (L = i), p !== null && (S = p ? 1 : 0), h !== -1 && (b = h), d !== 0 && (k = d), f !== 0 && (y = f), (m << 0 | L << 8 | S << 10 | b << 11 | k << 15 | y << 24) >>> 0;
        ...
        class y {
          ...
          _tokenize(_, v, A, E) {
            ...
            if (this._rootId === -1 && (this._rootId = h.RuleFactory.getCompiledRuleId(this._grammar.repository.$self, this, this._grammar.repository)), v && v !== u.NULL)
              ...
              let V;
              V = J ? w.createRootAndLookUpScopeName(J, Z, this) : w.createRoot("unknown", Z), v = new u(null, this._rootId, -1, -1, !1, null, V, V);
            }
            _ += `
`;
        ...
        class w {
          ...
          static createRoot(_, v) {
            return new w(null, new d.ScopeStack(null, _), v);
          }
          static createRootAndLookUpScopeName(_, v, A) {
            const E = A.getMetadataForScope(_), D = new d.ScopeStack(null, _), T = A.themeProvider.themeMatch(D), q = w.mergeAttributes(v, E, T);
            return new w(null, D, q);
          }
          get scopeName() {
            return this.scopePath.scopeName;
          }
          equals(_) {
            return w._equals(this, _);
          }
          static _equals(_, v) {
            for (; ; ) {
              if (_ === v || !_ && !v)
          ...
          pushAttributed(_, v) {
            if (_ === null)
              return this;
            if (_.indexOf(" ") === -1)
              return w._pushAttributed(this, _, v);
            const A = _.split(/ /g);
            let E = this;
            for (const D of A)
              E = w._pushAttributed(E, D, v);
            return E;
          }
          static _pushAttributed(_, v, A) {
            const E = A.getMetadataForScope(v), D = _.scopePath.push(v), T = A.themeProvider.themeMatch(D), q = w.mergeAttributes(_.tokenAttributes, E, T);
            return new w(_, D, q);
          }
          getScopeNames() {
        ...
        function h(w, u, g, x) {
          ...
          const v = g.lookup(u);
          w instanceof l ? f({ baseGrammar: v, selfGrammar: _ }, x) : d(w.ruleName, { baseGrammar: v, selfGrammar: _, repository: _.repository }, x);
          const A = g.injections(w.scopeName);
          if (A)
            for (const E of A)
              x.add(new l(E));
        }
        function d(w, u, g) {
          u.repository && u.repository[w] && m([u.repository[w]], u, g);
        }
        function f(w, u) {
          w.selfGrammar.patterns && Array.isArray(w.selfGrammar.patterns) && m(w.selfGrammar.patterns, { ...w, repository: w.selfGrammar.repository }, u), w.selfGrammar.injections && m(Object.values(w.selfGrammar.injections), { ...w, repository: w.selfGrammar.repository }, u);
        }
        function m(w, u, g) {
          for (const x of w) {
        ...
        s.ExternalReferenceCollector = p, s.ScopeDependencyProcessor = class {
          constructor(w, u) {
            this.repo = w, this.initialScopeName = u, this.seenFullScopeRequests = /* @__PURE__ */ new Set(), this.seenPartialScopeRequests = /* @__PURE__ */ new Set(), this.seenFullScopeRequests.add(this.initialScopeName), this.Q = [new l(this.initialScopeName)];
          }
          processQueue() {
            const w = this.Q;
            this.Q = [];
        ...
        function C(w) {
          ...
          if (u === -1)
            return new k(w);
          if (u === 0)
            return new b(w.substring(1));
          {
            const g = w.substring(0, u), x = w.substring(u + 1);
            return new y(g, x);
          }
        }
        s.TopLevelRepositoryReference = y, s.parseInclude = C;
      }, 391: function(r, s, a) {
        ...
        class h {
          constructor(y, C) {
            this.stack = y, this.stoppedEarly = C;
          }
        }
        function d(k, y, C, w, u, g, x, _) {
          const v = y.content.length;
          let A = !1, E = -1;
          if (x) {
            ...
            u = q.stack, w = q.linePos, C = q.isFirstLine, E = q.anchorPosition;
          }
          const D = Date.now();
          for (; !A; ) {
            if (_ !== 0 && Date.now() - D > _)
          ...
          return new h(u, !1);
          function T() {
            c.DebugFlags.InDebugMode && (console.log(""), console.log(`@@scanNext ${w}: |${y.content.substr(w).replace(/\n$/, "\\n")}|`));
            const q = function(O, Z, J, V, G, $) {
              const z = function(oe, ve, He, fe, ge, je) {
                const xe = ge.getRule(oe), { ruleScanner: Ae, findOptions: Se } = f(xe, oe, ge.endRule, He, fe === je);
                let _e = 0;
                c.DebugFlags.InDebugMode && (_e = p.performanceNow());
                const ee = Ae.findNextMatchSync(ve, fe, Se);
                if (c.DebugFlags.InDebugMode) {
                  const Le = p.performanceNow() - _e;
                  Le > 5 && console.warn(`Rule ${xe.debugName} (${xe.id}) matching took ${Le} against '${ve}'`), console.log(`  scanning for (linePos: ${fe}, anchorPosition: ${je})`), console.log(Ae.toString()), ee && console.log(`matched rule id: ${ee.ruleId} from ${ee.captureIndices[0].start} to ${ee.captureIndices[0].end}`);
                }
                return ee ? { captureIndices: ee.captureIndices, matchedRuleId: ee.ruleId } : null;
              }(O, Z, J, V, G, $), Y = O.getInjections();
              if (Y.length === 0)
                return z;
              const j = function(oe, ve, He, fe, ge, je, xe) {
                ...
                for (let Re = 0, N = oe.length; Re < N; Re++) {
                  ...
                  if (!P.matcher(Le))
                    continue;
                  const X = ve.getRule(P.ruleId), { ruleScanner: se, findOptions: W } = f(X, ve, null, fe, ge === xe), H = se.findNextMatchSync(He, ge, W);
                  if (!H)
                    continue;
            ...
            const R = q.captureIndices, F = q.matchedRuleId, M = !!(R && R.length > 0) && R[0].end > w;
            if (F === i.endRuleId) {
              const O = u.getRule(k);
              c.DebugFlags.InDebugMode && console.log("  popping " + O.debugName + " - " + O.debugEndRegExp), g.produce(u, R[0].start), u = u.withContentNameScopesList(u.nameScopesList), S(k, y, C, u, g, O.endCaptures, R), g.produce(u, R[0].end);
              const Z = u;
              if (u = u.parent, E = Z.getAnchorPos(), !M && Z.getEnterPos() === w)
              ...
              const Z = u, J = O.getName(y.content, R), V = u.contentNameScopesList.pushAttributed(J, k);
              if (u = u.push(F, w, E, R[0].end === v, null, V, V), O instanceof i.BeginEndRule) {
                const G = O;
                c.DebugFlags.InDebugMode && console.log("  pushing " + G.debugName + " - " + G.debugBeginRegExp), S(k, y, C, u, g, G.beginCaptures, R), g.produce(u, R[0].end), E = R[0].end;
                const $ = G.getContentName(y.content, R), z = V.pushAttributed($, k);
                if (u = u.withContentNameScopesList(z), G.endHasBackReferences && (u = u.withEndRule(G.getEndWithResolvedBackReferences(y.content, R))), !M && Z.hasSameRuleAs(u))
                ...
                const G = O;
                c.DebugFlags.InDebugMode && console.log("  pushing " + G.debugName), S(k, y, C, u, g, G.beginCaptures, R), g.produce(u, R[0].end), E = R[0].end;
                const $ = G.getContentName(y.content, R), z = V.pushAttributed($, k);
                if (u = u.withContentNameScopesList(z), G.whileHasBackReferences && (u = u.withEndRule(G.getWhileWithResolvedBackReferences(y.content, R))), !M && Z.hasSameRuleAs(u))
                ...
                const G = O;
                if (c.DebugFlags.InDebugMode && console.log("  matched " + G.debugName + " - " + G.debugMatchRegExp), S(k, y, C, u, g, G.captures, R), g.produce(u, R[0].end), u = u.pop(), !M)
            ...
            R[0].end > w && (w = R[0].end, C = !1);
          }
        }
        function f(k, y, C, w, u) {
          return c.UseOnigurumaFindOptions ? { ruleScanner: k.compile(y, C), findOptions: L(w, u) } : { ruleScanner: k.compileAG(y, C, w, u), findOptions: 0 };
        }
        function m(k, y, C, w, u) {
          return c.UseOnigurumaFindOptions ? { ruleScanner: k.compileWhile(y, C), findOptions: L(w, u) } : { ruleScanner: k.compileWhileAG(y, C, w, u), findOptions: 0 };
        }
        function L(k, y) {
          let C = 0;
          return k || (C |= 1), y || (C |= 4), C;
        }
        function S(k, y, C, w, u, g, x) {
          if (g.length === 0)
            return;
          const _ = y.content, v = Math.min(g.length, x.length), A = [], E = x[0].end;
          for (let D = 0; D < v; D++) {
            const T = g[D];
            if (T === null)
              continue;
            ...
            if (A.length > 0 ? u.produceFromScopes(A[A.length - 1].scopes, q.start) : u.produce(w, q.start), T.retokenizeCapturedWithRuleId) {
              const F = T.getName(_, x), M = w.contentNameScopesList.pushAttributed(F, k), O = T.getContentName(_, x), Z = M.pushAttributed(O, k), J = w.push(T.retokenizeCapturedWithRuleId, q.start, -1, !1, null, M, Z), V = k.createOnigString(_.substring(0, q.end));
              d(k, V, C && q.start === 0, q.start, J, u, !1, 0), l.disposeOnigString(V);
              continue;
            }
            const R = T.getName(_, x);
            if (R !== null) {
              const F = (A.length > 0 ? A[A.length - 1].scopes : w.contentNameScopesList).pushAttributed(R, k);
        ...
        Object.defineProperty(s, "__esModule", { value: !0 }), s.parseJSON = void 0, s.parseJSON = function(p, h, d) {
          ...
          for (; i(f, m); ) {
            if (L === 0) {
              if (S !== null && w("too many constructs in root"), m.type === 3) {
                S = {}, d && (S.$vscodeTextmateLocation = m.toLocation(h)), y(), L = 1;
                continue;
              }
              if (m.type === 2) {
                S = [], y(), L = 4;
            ...
            if (L === 1 || L === 3) {
              ...
              if (m.type === 1) {
                let u = m.value;
                if (i(f, m) && m.type === 6 || w("expected colon"), i(f, m) || w("expected value"), L = 2, m.type === 1) {
                  S[u] = m.value;
                  continue;
                }
                if (m.type === 8) {
                ...
                if (m.type === 3) {
                  let g = {};
                  d && (g.$vscodeTextmateLocation = m.toLocation(h)), S[u] = g, y(), L = 1, S = g;
                  continue;
                }
              }
              w("unexpected token in dict");
            }
            if (L === 5) {
              if (m.type === 4) {
                C();
            ...
            if (L === 4 || L === 6) {
              ...
              if (m.type === 3) {
                let u = {};
                d && (u.$vscodeTextmateLocation = m.toLocation(h)), S.push(u), y(), L = 1, S = u;
                continue;
              }
              w("unexpected token in array");
            }
            w("unknown state");
          }
          return k.length !== 0 && w("unclosed constructs"), S;
        };
        class c {
          constructor(h) {
        ...
        function i(p, h) {
          ...
          if (h.offset = m, h.line = S, h.char = b, d === 34) {
            ...
            h.value = f.substring(h.offset + 1, m - 1).replace(/\\u([0-9A-Fa-f]{4})/g, (k, y) => String.fromCodePoint(parseInt(y, 16))).replace(/\\(.)/g, (k, y) => {
              switch (y) {
                case '"':
                  return '"';
                case "\\":
...
`;
        ...
        l(a(44), s), s.Registry = class {
          ...
          async _loadGrammar(m, L, S, b, k) {
            const y = new f.ScopeDependencyProcessor(this._syncRegistry, m);
            for (; y.Q.length > 0; )
              await Promise.all(y.Q.map((C) => this._loadSingleGrammar(C.scopeName))), y.processQueue();
        ...
        function a(c, l, i) {
          ...
          let C = 0, w = null, u = [], g = [], x = null;
          function _(j, Q) {
            u.push(C), g.push(w), C = j, w = Q;
          }
          function v() {
            if (u.length === 0)
          ...
          const E = function() {
            ...
            let j = {};
            i !== null && (j[i] = { filename: l, line: d, char: f }), w[x] = j, x = null, _(1, j);
          }, D = function() {
            if (x === null)
              return A("missing <key>");
            let j = [];
            ...
            let j = {};
            i !== null && (j[i] = { filename: l, line: d, char: f }), w.push(j), _(1, j);
          }, q = function() {
            let j = [];
            w.push(j), _(2, j);
          };
          ...
          for (; h < p && (S(), !(h >= p)); ) {
            ...
            switch (U.name) {
              case "dict":
                C === 1 ? E() : C === 2 ? T() : (w = {}, i !== null && (w[i] = { filename: l, line: d, char: f }), _(1, w)), U.isClosed && R();
                continue;
              case "array":
                C === 1 ? D() : C === 2 ? q() : (w = [], _(2, w)), U.isClosed && F();
                continue;
              case "key":
        ...
        s.endRuleId = -1, s.whileRuleId = -2, s.ruleIdFromNumber = function(w) {
          return w;
        }, s.ruleIdToNumber = function(w) {
          return w;
        };
        class h {
          constructor(u, g, x, _) {
        ...
        class f extends h {
          ...
          _getCachedCompiledPatterns(u) {
            return this._cachedCompiledPatterns || (this._cachedCompiledPatterns = new y(), this.collectPatterns(u, this._cachedCompiledPatterns)), this._cachedCompiledPatterns;
          }
        }
        s.MatchRule = f;
        class m extends h {
        ...
        class L extends h {
          ...
          _getCachedCompiledPatterns(u, g) {
            if (!this._cachedCompiledPatterns) {
              this._cachedCompiledPatterns = new y();
              for (const x of this.patterns)
        ...
        class S extends h {
          ...
          _getCachedCompiledWhilePatterns(u, g) {
            return this._cachedCompiledWhilePatterns || (this._cachedCompiledWhilePatterns = new y(), this._cachedCompiledWhilePatterns.push(this._while.hasBackReferences ? this._while.clone() : this._while)), this._while.hasBackReferences && this._cachedCompiledWhilePatterns.setSource(0, g || "￿"), this._cachedCompiledWhilePatterns;
          }
        }
        s.BeginWhileRule = S;
        class b {
...
`);
        ...
        class l {
          constructor(k, y, C) {
            this._colorMap = k, this._defaults = y, this._root = C, this._cachedMatchRoot = new c.CachedFn((w) => this._root.match(w));
          }
          static createFromRawTheme(k, y) {
            return this.createFromParsedTheme(d(k), y);
          }
          static createFromParsedTheme(k, y) {
            return function(C, w) {
              C.sort((E, D) => {
              ...
              let _ = new m(w), v = new h(u, _.getId(g), _.getId(x)), A = new S(new L(0, null, -1, 0, 0), []);
          ...
          match(k) {
            if (k === null)
              return this._defaults;
            const y = k.scopeName, C = this._cachedMatchRoot.get(y).find((w) => function(u, g) {
              if (g === null)
                return !0;
              let x = 0, _ = g[x];
              for (; u; ) {
        ...
        class i {
          constructor(k, y) {
            this.parent = k, this.scopeName = y;
          }
          static from(...k) {
            let y = null;
        ...
        class h {
          constructor(k, y, C) {
            this.fontStyle = k, this.foregroundId = y, this.backgroundId = C;
          }
        }
        function d(b) {
          if (!b)
          ...
          if (!b.settings || !Array.isArray(b.settings))
            return [];
          let k = b.settings, y = [], C = 0;
          for (let w = 0, u = k.length; w < u; w++) {
            let g, x = k[w];
            if (!x.settings)
              continue;
            ...
            for (let E = 0, D = g.length; E < D; E++) {
              ...
              T.length > 1 && (R = T.slice(0, T.length - 1), R.reverse()), y[C++] = new f(q, R, w, _, v, A);
            }
          }
          return y;
        }
        ...
        class f {
          constructor(k, y, C, w, u, g) {
            this.scope = k, this.parentScopes = y, this.index = C, this.fontStyle = w, this.foreground = u, this.background = g;
          }
        }
        ...
        class m {
          constructor(k) {
            if (this._lastColorId = 0, this._id2color = [], this._color2id = /* @__PURE__ */ Object.create(null), Array.isArray(k)) {
              this._isFrozen = !0;
              for (let y = 0, C = k.length; y < C; y++)
                this._color2id[k[y]] = y, this._id2color[y] = k[y];
            } else
              this._isFrozen = !1;
          }
          getId(k) {
            if (k === null)
              return 0;
            k = k.toUpperCase();
            let y = this._color2id[k];
            if (y)
              return y;
            if (this._isFrozen)
              throw new Error(`Missing color in color map - ${k}`);
            return y = ++this._lastColorId, this._color2id[k] = y, this._id2color[y] = k, y;
          }
          getColorMap() {
        ...
        s.ColorMap = m;
        class L {
          constructor(k, y, C, w, u) {
            this.scopeDepth = k, this.parentScopes = y, this.fontStyle = C, this.foreground = w, this.background = u;
          }
          clone() {
          ...
          acceptOverwrite(k, y, C, w) {
            this.scopeDepth > k ? console.log("how did this happen?") : this.scopeDepth = k, y !== -1 && (this.fontStyle = y), C !== 0 && (this.foreground = C), w !== 0 && (this.background = w);
          }
        }
        s.ThemeTrieElementRule = L;
        class S {
          constructor(k, y = [], C = {}) {
            this._mainRule = k, this._children = C, this._rulesWithParentScopes = y;
          }
          static _sortBySpecificity(k) {
            return k.length === 1 || k.sort(this._cmpBySpecificity), k;
          }
          static _cmpBySpecificity(k, y) {
            if (k.scopeDepth === y.scopeDepth) {
              const C = k.parentScopes, w = y.parentScopes;
              let u = C === null ? 0 : C.length, g = w === null ? 0 : w.length;
              if (u === g)
                for (let x = 0; x < u; x++) {
                  const _ = C[x].length, v = w[x].length;
                  if (_ !== v)
                    return v - _;
                }
              return g - u;
            }
            return y.scopeDepth - k.scopeDepth;
          }
          match(k) {
            if (k === "")
              return S._sortBySpecificity([].concat(this._mainRule).concat(this._rulesWithParentScopes));
            let y, C, w = k.indexOf(".");
            return w === -1 ? (y = k, C = "") : (y = k.substring(0, w), C = k.substring(w + 1)), this._children.hasOwnProperty(y) ? this._children[y].match(C) : S._sortBySpecificity([].concat(this._mainRule).concat(this._rulesWithParentScopes));
          }
          insert(k, y, C, w, u, g) {
            if (y === "")
              return void this._doInsertHere(k, C, w, u, g);
            let x, _, v, A = y.indexOf(".");
            A === -1 ? (x = y, _ = "") : (x = y.substring(0, A), _ = y.substring(A + 1)), this._children.hasOwnProperty(x) ? v = this._children[x] : (v = new S(this._mainRule.clone(), L.cloneArr(this._rulesWithParentScopes)), this._children[x] = v), v.insert(k + 1, _, C, w, u, g);
          }
          _doInsertHere(k, y, C, w, u) {
            if (y !== null) {
              for (let g = 0, x = this._rulesWithParentScopes.length; g < x; g++) {
                let _ = this._rulesWithParentScopes[g];
                if (c.strArrCmp(_.parentScopes, y) === 0)
                  return void _.acceptOverwrite(k, C, w, u);
              }
              C === -1 && (C = this._mainRule.fontStyle), w === 0 && (w = this._mainRule.foreground), u === 0 && (u = this._mainRule.background), this._rulesWithParentScopes.push(new L(k, y, C, w, u));
            } else
              this._mainRule.acceptOverwrite(k, C, w, u);
          }
        }
...
var we = /* @__PURE__ */ ((n) => (n[n.NotSet = -1] = "NotSet", n[n.None = 0] = "None", n[n.Italic = 1] = "Italic", n[n.Bold = 2] = "Bold", n[n.Underline = 4] = "Underline", n))(we || {});
class ne {
  ...
  function m() {
    ...
    if (o < n.length && (n.charCodeAt(o) === 69 || n.charCodeAt(o) === 101))
      if (o++, (o < n.length && n.charCodeAt(o) === 43 || n.charCodeAt(o) === 45) && o++, o < n.length && Oe(n.charCodeAt(o))) {
        ...
        h = 3;
    return n.substring(y, C);
  }
  function L() {
    let y = "", C = o;
    for (; ; ) {
      if (o >= t) {
        y += n.substring(C, o), h = 2;
        break;
      }
      const w = n.charCodeAt(o);
      if (w === 34) {
        y += n.substring(C, o), o++;
        break;
      }
      if (w === 92) {
        if (y += n.substring(C, o), o++, o >= t) {
          h = 2;
          break;
        }
...
`;
          ...
          case 117:
            const g = d(4, !0);
            g >= 0 ? y += String.fromCharCode(g) : h = 4;
            break;
          default:
            h = 5;
        }
  ...
  function S() {
    if (r = "", h = 0, s = o, l = c, p = i, o >= t)
      return s = t, a = 17;
    let y = n.charCodeAt(o);
    if (Bn(y)) {
      do
        o++, r += String.fromCharCode(y), y = n.charCodeAt(o);
      while (Bn(y));
      return a = 15;
    }
    if (We(y))
      return o++, r += String.fromCharCode(y), y === 13 && n.charCodeAt(o) === 10 && (o++, r += `
`), c++, i = o, a = 14;
    switch (y) {
      case 123:
        return o++, a = 1;
      ...
      case 47:
        ...
        return r += String.fromCharCode(y), o++, a = 16;
      case 45:
        if (r += String.fromCharCode(y), o++, o === t || !Oe(n.charCodeAt(o)))
          return a = 16;
      case 48:
      case 49:
      case 50:
...
function f_e(n, e, t = un.DEFAULT) {
  ...
  const i = a(e.onObjectBegin), p = l(e.onObjectProperty), h = s(e.onObjectEnd), d = a(e.onArrayBegin), f = s(e.onArrayEnd), m = l(e.onLiteralValue), L = c(e.onSeparator), S = s(e.onComment), b = c(e.onError), k = t && t.disallowComments, y = t && t.allowTrailingComma;
  function C() {
    for (; ; ) {
      const E = o.scan();
  ...
  function x() {
    return o.getToken() !== 10 ? (w(3, [], [
      2,
      5
      /* SyntaxKind.CommaToken */
    ]), !1) : (u(!1), o.getToken() === 6 ? (L(":"), C(), A() || w(4, [], [
      2,
      5
      /* SyntaxKind.CommaToken */
    ])) : w(5, [], [
  ...
  function v() {
    ...
    for (; o.getToken() !== 4 && o.getToken() !== 17; ) {
      if (o.getToken() === 5) {
        if (D || w(4, [], []), L(","), C(), o.getToken() === 4 && y)
          break;
      } else
        D && w(6, [], []);
      E ? (r.push(0), E = !1) : r[r.length - 1]++, A() || w(4, [], [
        4,
        5
        /* SyntaxKind.CommaToken */
      ]), D = !0;
    }
    return f(), E || r.pop(), o.getToken() !== 4 ? w(8, [
      4
  ...
  return C(), o.getToken() === 17 ? t.allowEmptyContent ? !0 : (w(4, [], []), !1) : A() ? (o.getToken() !== 17 && w(9, [], []), !0) : (w(4, [], []), !1);
}
var so;
(function(n) {
...
function L_e(n, e, t, o, r) {
  ...
  for (let i = 0, p = s.length; i < p; i++) {
    ...
    for (let b = 0; b < S; b++) {
      let k = L.tokens[2 * b], y = b + 1 < S ? L.tokens[2 * b + 2] : h.length;
      if (k === y)
        continue;
      let C = L.tokens[2 * b + 1], w = ne.getForeground(C), u = e[w], g = ne.getFontStyle(C), x = [];
    ...
    if (!Number.isNaN(o))
      if (o === 0)
        ...
        o === 49 ? e.push({
          ...
          type: "setForegroundColor",
          value: { type: "named", name: me[o - 90 + 8] }
        }) : o >= 100 && o <= 107 && e.push({
          type: "setBackgroundColor",
          value: { type: "named", name: me[o - 100 + 8] }
        });
  }
  return e;
}
...
function P_e(n, e) {
  ...
  return t.map(
    (s) => r.parse(s).map((a) => {
      ...
      let l = we.None;
      return a.decorations.has("bold") && (l |= we.Bold), a.decorations.has("italic") && (l |= we.Italic), a.decorations.has("underline") && (l |= we.Underline), {
        content: a.value,
        color: c,
        fontStyle: l
      };
...
function I_e(n) {
  ...
  if (e)
    if (e[3]) {
      const o = Math.round(Number.parseInt(e[3], 16) / 2).toString(16).padStart(2, "0");
      return `#${e[1]}${e[2]}${o}`;
    } else
      return e[2] ? `#${e[1]}${e[2]}80` : `#${Array.from(e[1]).map((o) => `${o}${o}`).join("")}80`;
        ...
        n.map((a, c) => {
          ...
          return s(
            ...
            a.map((h, d) => {
              ...
              return h.fontStyle & we.Italic && f.push("font-style: italic"), h.fontStyle & we.Bold && f.push("font-weight: bold"), h.fontStyle & we.Underline && f.push("text-decoration: underline"), s(
                "token",
                {
                  style: f.join("; "),
                  tokens: a,
...
function G_e() {
  ...
  for (let e = 0; e < me.length; e++) {
    const t = `#A${e.toString().padStart(5, "0")}`, o = me[e].replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
    n[t] = `var(--shiki-color-ansi-${o})`;
  }
  return n;
}
async function U_e(n) {
  var x, _;
  const { _languages: e, _themes: t, _wasmPath: o } = z_e(n), r = new S_e(w_e(o), "vscode-oniguruma"), s = new $_e(r);
  ...
  function h(v, A) {
    v.bg = i[v.bg] || v.bg, v.fg = i[v.fg] || v.fg, Object.entries(v.colors).forEach(([E, D]) => {
      v.colors[E] = i[D] || D;
    }), A.forEach((E, D) => {
      A[D] = i[E] || E;
    });
...
async function V_e(n = {}) {
  const e = await U_e(n), t = n.processors ?? [];
  return {
    ...e,
    codeToHtml: (o, r) => {
...
const W_e = Yge("abcdefghijklmnopqrstuvwxyz", 10), Z_e = (n) => {
...
async function Q_e(n = "material-theme-palenight", e = [], t = "", o = console) {
...
The language '${S}' is not loaded, falling back to '${t || "txt"}' for syntax highlighting.`
    ...
    const y = Z_e(b), C = (E) => E.replace(p, (D, T) => `<pre ${k}${T.replace(' tabindex="0"', "")}>`).replace(i, (D, T) => D.replace(T, "")), w = /* @__PURE__ */ new Map(), u = (E) => k ? E : E.replace(f, (D) => {
      let T = w.get(D);
      return T || (T = W_e(), w.set(D, T)), T;
    }), g = (E) => (w.forEach((D, T) => {
...
`), h = `<div class="line-numbers-wrapper" aria-hidden="true">${[
  ...
  var c;
  const { plugin: o, highlighter: r, loadLang: s } = await Q_e(n.theme, n.languages, n.defaultHighlightLang, t), a = Tz({
    html: !0,
    linkify: !0,
    highlight: n.highlight || o,
    ...n
  });
  return a.linkify.set({ fuzzyLink: !1 }), a.use(Y_e).use(e_e).use(t_e).use(X_e).use(nbe, { target: "_blank", rel: "noreferrer", ...n.externalLinks }, e).use(K_e, n.lineNumbers), (c = n.attrs) != null && c.disable || a.use(Gz, n.attrs), a.use(Wge), a.use(De, {
    slugify: sn,
    permalink: De.permalink.linkInsideHeader({
...
function rbe(n, e) {
  return re(), ie("svg", tbe, sbe);
}
const cbe = { name: "tabler-download", render: rbe }, abe = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, ibe = /* @__PURE__ */ le("path", {
  fill: "none",
  stroke: "currentColor",
  "stroke-linecap": "round",
  "stroke-linejoin": "round",
...
function ube(n, e) {
  return re(), ie("svg", abe, lbe);
}
const pbe = { name: "tabler-check", render: ube }, hbe = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, dbe = /* @__PURE__ */ le("g", {
...
function mbe(n, e) {
  return re(), ie("svg", hbe, fbe);
}
const gbe = { name: "tabler-copy", render: mbe };
async function _be(n) {
  try {
...
const bbe = (n, e = !1) => {
  ...
  html: ".html",
  css: ".css"
}, wbe = (n, e, t = "Enter file name") => {
  const o = kbe[n] || ".file", r = `file-${bbe(3, !0)}${o}`, s = window.prompt(t || "", r);
  if (!s)
    return;
...
}, ybe = { class: "vp-header" }, vbe = { class: "ctrl" }, Kn = /* @__PURE__ */ pn({
  ...
  setup(n) {
    ...
    function a() {
      wbe(e.lang, e.item, e.downloadTxt);
    }
    return (c, l) => {
      const i = gbe, p = pbe, h = cbe;
...
}), xbe = { class: "tabs" }, Abe = ["onClick"], Sbe = ["innerHTML"], Lbe = /* @__PURE__ */ pn({
  __name: "VueGroupCode",
  props: {
    names: {
      type: Object,
...
const Tbe = /* @__PURE__ */ pn({
  ...
  setup(n, {
    ...
    function p(L, S = "") {
      let b = "";
      const y = new DOMParser().parseFromString(L, "text/html"), C = /shellscript|shell|bash|sh|zsh/.test(S);
      return y.querySelectorAll("span.line:not(.diff.remove)").forEach((w) => b += (w.textContent || "") + `
`), C && (b = b.replace(/^ *(\$|>) /gm, "").trim()), b.slice(0, -1);
    }
    const h = Un(() => Cbe(n.content || ""));
    function d(L) {
      if (L.nodeType === Node.TEXT_NODE)
        return L.textContent;
      if (L.nodeType === Node.ELEMENT_NODE) {
        const S = L, b = /^language-/, k = Array.from(S.classList).some((w) => b.test(w)), y = /vp-code-group/;
        if (Array.from(S.classList).some((w) => y.test(w))) {
          ...
          const w = S.className.match(/language-([\w+]+)/), u = w ? w[1] : "plain", g = p(S.innerHTML, u), x = S.innerHTML;
          return be("div", {
            class: i.value,
            style: {
              ...l
          ...
          const w = Array.from(S.childNodes).map(d).flat(), u = {};
    ...
    async function f() {
      ...
      if (L && r.value)
        for (let b = 0; b < L.length; b++) {
          const k = L[b];
          try {
            const y = $o[k.toLocaleLowerCase()] || k;
            await r.value(y);
          } catch {
            continue;
          }
...
export {
  ...
  Tbe as VueMarkdownIt,
  Dbe as VueMarkdownItProvider,
  qbe as default
};
